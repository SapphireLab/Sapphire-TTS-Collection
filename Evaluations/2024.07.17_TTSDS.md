...
> The second method is \textit{UTMOS}~\cite{saeki2022utmos}, which is an ensemble MOS prediction system that won several categories in the 2022 VoiceMOS challenge \cite{huang2022voicemos}, and has since been used for evaluation of several leading TTS systems (**[XTTS (2024)](../Models/Speech_LLM/2024.06.07_XTTS.md)**; **[NaturalSpeech3 (2024)](../Models/Diffusion/2024.03.05_NaturalSpeech3.md)**).
>
