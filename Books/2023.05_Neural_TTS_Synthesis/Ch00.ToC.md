...
|[Tacotron](../../Papers/2017.03_Tacotron.md) [49]|AM|ch/ph→(AR)→linS→wav|IS17|2017.03|
...
|[Tacotron 2](../../Papers/2017.12_Tacotron2.md) [55]|AM|ch/ph→(AR)→melS→(AR)→wav|ICASSP18|2017.12|
...
|TransformerTTS [67]|AM|ph→(AR)→melS→(AR)→wav|AAAI19|2018.09|
...
|[SpeedySpeech](../../Papers/2020.08_SpeedySpeech.md) [105]|AM|ph→(FF)→melS→(FF)→wav|IS20|2020.08|
...
|[HiFi-GAN](../../Papers//2020.10_HiFi-GAN.md) [110]|Voc|melS→(FF)→wav|NeurIPS20|2020.10|
...
|[VITS](../../Papers/2021.06_VITS.md) [130]|E2E|ph→(FF)→wav|ICML21|2021.06|
...
|[NaturalSpeech](../../papers/2022.03_NaturalSpeech.md) [137]|E2E|ph→(FF)→wav|arXiv22|2022.05|