...
声学特征的学习在很大程度上参考了图像领域的工作, 用到的主要是类似于 [VQ-VAE](../../Models/_Basis_CV/VQ-VAE.md), [VQGAN](../../Models/_Basis_CV/VQGAN.md) 等的离散化压缩方法, 并针对语音数据的特性做了优化.
...
基于上述考虑, 模型大体上应该是 [VQ-VAE](../../Models/_Basis_CV/VQ-VAE.md) 的结构.
...
- 复旦: [SpeechGPT](../../Models/Speech_LLM/SpeechGPT.md)/[SpeechGPT-Gen](../../Models/Speech_LLM/SpeechGPT-Gen.md)/[SpeechAlign](../../Models/Speech_LLM/SpeechAlign.md);
- 阿里: [LauraGPT](../../Models/Speech_LLM/2023.10.07_LauraGPT.md)
- 新加坡国立大学: [NextGPT](../../Models/Speech_LLM/NextGPT.md).
...
[SpeechGPT](../../Models/Speech_LLM/SpeechGPT.md) 做的也是兼具语音理解能力和语音生成能力的多模态模型.
在模型的训练上, [SpeechGPT](../../Models/Speech_LLM/SpeechGPT.md) 大幅度向 LLM 看齐, 使用了三段式的训练方法：
...
对于上面的第一个问题, 作者在其后的 [SpeechGPT-Gen](../../Models/Speech_LLM/SpeechGPT-Gen.md) 中做了解决.

解决思路的核心点就是：让模型不仅看到语音的语义 Token, 也要看到语音的声学 Token .
具体做法是：
[SpeechGPT](../../Models/Speech_LLM/SpeechGPT.md) 的 [HuBERT](../../Models/Speech_Representaion/2021.06.14_HuBERT.md) 特征替换成了 [SpeechTokenizer](../../Models/Speech_Neural_Codec/2023.08.31_SpeechTokenizer.md) 中的语义特征, 用 SpeechGPT 这一 LLM 来自回归地建模语义特征, 有了语义特征之后, 再使用 Flow-Matching 这样的扩散模型来建模声学特征.
...
对于第二个问题, 以 [VoiceLDM](../../Models/_tmp/VoiceLDM.md) 和 [ParlerTTS](../../Models/_tmp/ParlerTTS.md) 为代表的 Text/Prompt-Guided Zero-Shot TTS 工作给出了肯定的答案.
...
[NaturalSpeech3](../../Models/Diffusion/2024.03.05_NaturalSpeech3.md), 还是非自回归的, 而且非自回归的正统性味道更加浓厚, 借用了不少 [FastSpeech2](../../Models/TTS2_Acoustic/2020.06.08_FastSpeech2.md) 和 [Mega-TTS](../../Models/_tmp/2023.06.06_Mega-TTS.md), [Mega-TTS2](../../Models/_tmp/2023.07.14_Mega-TTS2.md) 的设计思想.
像 [Mega-TTS](../../Models/_tmp/2023.06.06_Mega-TTS.md), [Mega-TTS2](../../Models/_tmp/2023.07.14_Mega-TTS2.md) 一样, 同样采用(自)监督信号对语音 Token 编码的内容做了限制, 而不再像是 [VALL-E](../../Models/Speech_LLM/2023.01.05_VALL-E.md)/[NaturalSpeech2](../../Models/Diffusion/2023.04.18_NaturalSpeech2.md) 那样一把抓.
...
对于 MEL+VQ 的工作, 有 Tortoise-TTS, XTTS2, [Mega-TTS](../../Models/_tmp/2023.06.06_Mega-TTS.md), [Mega-TTS2](../../Models/_tmp/2023.07.14_Mega-TTS2.md), [BASE TTS](../../Models/Speech_LLM/2024.02.12_BASE-TTS.md).

##### Tortoise-TTS

该工作是著名的开源英文TTS模型.
其作者目前在 OpenAI 就职, 同时也是 GPT-4o 的重要 Contributor (他自个儿在博客中说的).
Tortoise-TTS 使用 MEL+[VQ-VAE](../../Models/_Basis_CV/VQ-VAE.md) 的方法得到语音的 MEL Token, 然后对 MEL  Token 以及 Text Token 做 GPT 自回归建模.
...
[Mega-TTS 2](../../Models/_tmp/2023.07.14_Mega-TTS2.md) 和 [Mega-TTS](../../Models/_tmp/2023.06.06_Mega-TTS.md) 总体上类似, 在音色编码 (音素级编码, 多条参考音频), 语音提示长度 (扩展同 Speaker 语音上下文长度硬Train, 音频 Prompt 长度更长)和时长建模 (也用 GPT 自回归) 上做了改进, 同时堆了更大规模的数据.

剪映的后端 TTS 模型用的就是 [Mega-TTS 2](../../Models/_tmp/2023.07.14_Mega-TTS2.md).

该工作在各论文的评测中表现也都不错.

#### 基于 MEL 频谱 + VAE 的工作

对于 MEL+Latents 的工作, 有：[AudioLDM](../../Models/Diffusion/AudioLDM.md), [AudioLDM](../../Models/Diffusion/AudioLDM2.md), [StyleTTS](../../Models/_tmp/2022.05_StyleTTS.md), [StyleTTS2](../../Models/_tmp/2023.06_StyleTTS2.md).

##### AudioLDM 系列.

[AudioLDM](../../Models/Diffusion/AudioLDM.md), [AudioLDM](../../Models/Diffusion/AudioLDM2.md) 使用的语音 Latents 是一致的, 均通过 MEL+VAE 获得.
既然是连续的 Latents, 使用扩散模型来建模也合情合理.
解码过程也相当简单：VAE Decoder 获得梅尔频谱, 然后用声码器转换为音频波形.

该系列工作的核心创新点是利用多模态模型统一了扩散模型条件输入侧的信息：
[AudioLDM](../../Models/Diffusion/AudioLDM.md) 用 CLAP 统一了文本模态和音频模态, 用单模态的音频数据就能完成模型的训练; 
[AudioLDM](../../Models/Diffusion/AudioLDM2.md) 则包含了图像, 文本, 转录文本等更多模态, 模型泛用性也更强, 既能做语音合成, 也能做音乐生成, 音频事件生成.
...
说是风格, 其实跟 [Mega-TTS 2](../../Models/_tmp/2023.07.14_Mega-TTS2.md) 的音色很像.
...
这方面的工作有：[PromptTTS](../../Models/_tmp/2022.11.22_PromptTTS.md), [InstructTTS](../../Models/_tmp/2023.01.31_InstructTTS.md), [ParlerTTS](../../Models/_tmp/ParlerTTS.md), [VoiceLDM](../../Models/Diffusion/VoiceLDM.md) 和 [Audiobox](../../Models/Speech_LLM/2023.12.25_Audiobox.md).

我们主要谈谈 [ParlerTTS](../../Models/_tmp/ParlerTTS.md) 和 [VoiceLDM](../../Models/Diffusion/VoiceLDM.md).
...
[VoiceLDM](../../Models/Diffusion/VoiceLDM.md) 在 [AudioLDM](../../Models/Diffusion/AudioLDM.md) 的基础上增加了转录文本的输入.
这个工作和 [AudioLDM](../../Models/Diffusion/AudioLDM.md) 很像, 同样使用 CLAP 注入语音的描述性信息.
...
- Audio & Text Tokenizer 的实现应该是语音离散化部分所用的技术, 例如 [SoundStream](../../Models/Speech_Neural_Codec/2021.07.07_SoundStream.md), [EnCodec](../../Models/Speech_Neural_Codec/2022.10.24_EnCodec.md), [SpeechTokenizer](../../Models/Speech_Neural_Codec/2023.08.31_SpeechTokenizer.md), 或者是 MEL+VQ 最后配合声码器来解码; 
  - 参考 Zero-Shot TTS, [AudioLM](../../Models/Speech_LLM/2022.09.07_AudioLM.md)/[AudioPaLM](../../Models/Speech_LLM/2023.06.22_AudioPaLM.md), [SpeechGPT-Gen](../../Models/Speech_LLM/SpeechGPT-Gen.md) 等工作的结果, LLM 中语音 Token 的解码应该是要走层次化或者多步的方法, 先解码语义特征, 再解码声学特征, 
  ...
  [AudioLDM2](../../Models/Diffusion/AudioLDM2.md) 虽然做了这方面的工作, 但 Audio/Music 和 Speech 的参数其实是不一样的, 说到底还不是同一个模型.
