...
> The first stage is to produce intermediate speech representations such as mel-spectrograms ([Tacotron2 (2017)](../2017.03_Tacotron/2017.12_Tacotron2.md)) or linguistic features (Oord et al., 2016) from the preprocessed text (Although there is a text preprocessing step in TTS systems, We herein use preprocessed text interchangeably with the word "text".), and the second stage is to generate raw waveforms conditioned on the intermediate representations (Oord et al., 2016; [WaveRNN (2018)](../2018.02_WaveRNN/2018.02_WaveRNN.md)).
...
> Neural network-based autoregressive TTS systems have shown the capability of synthesizing realistic speech ([Tacotron2 (2017)](../2017.03_Tacotron/2017.12_Tacotron2.md); [Transformer-TTS (2018)](../2018.09_Transformer_TTS/2018.09_Transformer_TTS.md)), but their sequential generative process makes it difficult to fully utilize modern parallel processors.
> To overcome this limitation and improve synthesis speed, several non-autoregressive methods have been proposed.
> In the text-to-spectrogram generation step, extracting attention maps from pre-trained autoregressive teacher networks ([FastSpeech (2019)](../2019.05_FastSpeech/2019.05_FastSpeech.md); [ParaNet]()) is attempted to decrease the difficulty of learning alignments between text and spectrograms.
> More recently, likelihood-based methods further eliminate the dependency on external aligners by estimating or learning alignments that maximize the likelihood of target mel-spectrograms ([AlignTTS (2020)](../2020.03_AlignTTS/2020.03_AlignTTS.md); [Flow-TTS (2020)](../2020.05_Flow-TTS/2020.05_Flow-TTS.md); [Glow-TTS (2020)](../2020.05_Glow-TTS/2020.05_Glow-TTS.md)).
> Meanwhile, [Generative Adversarial Networks (GANs)]() have been explored in second stage models.
> GAN-based feed-forward networks with multiple discriminators, each distinguishing samples at different scales or periods, achieve high-quality raw waveform synthesis ([MelGAN (2019)](../2019.10_MelGAN/2019.10_MelGAN.md); [GAN-TTS (2019)](../2019.09_GAN-TTS/2019.09_GAN-TTS.md); [HiFi-GAN (2020)](../2020.10_HiFi-GAN/2020.10_HiFi-GAN.md)).
...
近期, 有几项工作如 [FastSpeech 2s (2020)](../2019.05_FastSpeech/2020.06_FastSpeech2.md) 和 EATS 提出了高效的端到端训练方法, 如训练于较短的音频片段而不是完整波形, 利用梅尔频谱图解码器辅助文本表示学习, 并设计专门的频谱图损失以松弛目标和生成语音的长度不匹配.
...
> Our method obtains more natural sounding speech and higher sampling efficiency than the best publicly available TTS system, [Glow-TTS (2020)](../2020.05_Glow-TTS/2020.05_Glow-TTS.md) with [HiFi-GAN (2020)](../2020.10_HiFi-GAN/2020.10_HiFi-GAN.md). 
...
> Currently, neural TTS models with a two-stage pipeline can synthesize human-like speech ([WaveNet (2016)](../2016.09_WaveNet/2016.09_WaveNet22.md.md); [DeepVoice3](); [Tacotron2 (2017)](../2017.03_Tacotron/2017.12_Tacotron2.md)).
...
> [FastSpeech 2s (2020)](../2019.05_FastSpeech/2020.06_FastSpeech2.md) is an extension of FastSpeech 2 that enables end-to-end parallel generation by adopting adversarial training and an auxiliary mel-spectrogram decoder that helps learn text representations.
...
> [EATS (2020)](../2020.06_EATS/2020.06_EATS.md) employs adversarial training as well and a differentiable alignment scheme.
...
> Autoregressive TTS models ([VoiceLoop (2017.07)](../2017.07_VoiceLoop/2017.07_VoiceLoop.md); [Tacotron2 (2017)](../2017.03_Tacotron/2017.12_Tacotron2.md); [Flowtron (2021)](../2020.05_Flowtron/2020.05_Flowtron.md)) generate diverse speech with different rhythms through their autoregressive structure and several tricks including maintaining dropout probability during inference and priming ([Generating sequences with recurrent neural networks]()).
> Parallel TTS models ([FastSpeech (2019)](../2019.05_FastSpeech/2019.05_FastSpeech.md); [ParaNet (2020)](); [Glow-TTS (2020)](../2020.05_Glow-TTS/2020.05_Glow-TTS.md); [FastSpeech 2s (2020)](../2019.05_FastSpeech/2020.06_FastSpeech2.md); [BVAE-TTS (2020)](../2021.01_BVAE-TTS/2021.01_BVAE-TTS.md)), on the other hand, have been relied on deterministic duration prediction.
...
$$
  \log p_{\theta}(x|c) \geq \mathbb{E}_{q_{\phi}(z|x)}\left[\log p_{\theta}(x|z)-\log\dfrac{q_{\phi}(z|x)}{p_{\theta}(z|c)}\right] \tag{1}
$$
...
$$
  L_{recon}= \|x_{mel}−\hat{x}_{mel}\|_1 \tag{2}
$$
...
> In practice, we do not upsample the whole latent variables $z$ but use partial sequences as an input for the decoder, which is the windowed generator training used for efficient end-to-end training ([FastSpeech 2s (2020)](../2019.05_FastSpeech/2020.06_FastSpeech2.md); [EATS (2020)](../2020.06_EATS/2020.06_EATS.md)).
...
$$
  L_{kl} = \log q_{\phi}(z|x) -\log p_{\theta}(z|c_{text},A) \tag{3}
$$
...
> To find the optimal alignment, [Glow-TTS (2020)](../2020.05_Glow-TTS/2020.05_Glow-TTS.md) use dynamic programming. 
...
为了找到最优对齐, [Glow-TTS (2020)](../2020.05_Glow-TTS/2020.05_Glow-TTS.md) 使用动态规划.
...
> The duration could be used to train a deterministic duration predictor, as proposed in previous work ([HiFi-GAN (2020)](../2020.10_HiFi-GAN/2020.10_HiFi-GAN.md)), but it cannot express the way a person utters at different speaking rates each time. 
...
> We apply variational dequantization ([Flow++ (2019)](../2019.02_Flowpp/2019.02_Flowpp.md)) and variational data augmentation ([VFlow (2020)](../2020.02_VFlow/2020.02_VFlow.md)) to solve these problems. 
...
$$
  \log p_{\theta}(d|c_{text}) \geq \mathbb{E}_{q_{\phi}(u, ν|d, c_{text})} \left[\log\dfrac{p_{\theta}(d-u,v|c_{text})}{q_{\phi}(u,v|d,c_{text})}\right]\tag{7}
$$
...
$$
\begin{align}
  L_{adv}(D) &= \mathbb{E}_{(y,z)} [(D(y)-1)^2 + (D(G(z)))^2]\tag{8}\\
  L_{adv}(G) &= \mathbb{E}_{z} [(D(G(z)) - 1)^2]\tag{9}\\
  L_{fm}(G) &= \mathbb{E}_{(y,z)} \left[\sum_{l=1}^T \dfrac{1}{N_l}\| D^l(y)-D^l(G(z))\|_1\right]\tag{10}
\end{align}
$$
...
$$
  L_{vae} = L_{recon} + L_{kl} + L_{dur} + L_{adv}(G) + L_{fm}(G) \tag{11}
$$
...
> For the posterior encoder, we use the non-causal WaveNet residual blocks used in [WaveGlow (2018)](../2018.10_WaveGlow/2018.10_WaveGlow.md) and [Glow-TTS (2020)](../2020.05_Glow-TTS/2020.05_Glow-TTS.md). 
...
对于后验编码器, 我们采用 WaveGlow 和 Glow-TTS 中使用的非因果的 WaveNet 残差块.
...
> The text encoder is a [transformer](../2017.06_Transformer/2017.06_Transformer.md) encoder  that uses [relative positional representation](Self-Attention with Relative Position Representations) instead of absolute positional encoding.
...
> The decoder is essentially the [HiFi-GAN (2020)](../2020.10_HiFi-GAN/2020.10_HiFi-GAN.md) V1 generator.
...
> We follow the discriminator architecture of the multi-period discriminator proposed in [HiFi-GAN (2020)](../2020.10_HiFi-GAN/2020.10_HiFi-GAN.md).
> The multi-period discriminator is a mixture of Markovian window-based sub-discriminators ([MelGAN (2019)](../2019.10_MelGAN/2019.10_MelGAN.md)), each of which operates on different periodic patterns of input waveforms.
...
> Following previous work ([FastSpeech 2s (2020)](../2019.05_FastSpeech/2020.06_FastSpeech2.md); [EATS (2020)](../2020.06_EATS/2020.06_EATS.md)), we adopt the windowed generator training, a method of generating only a part of raw waveforms to reduce the training time and memory usage during training.
...
> To verify that our model can learn and express diverse speech characteristics, we compared our model to Tacotron 2, Glow-TTS and HiFi-GAN, which showed the ability to extend to multi-speaker speech synthesis ([Transfer Learning from Speaker Verification to Multispeaker Text-To-Speech Synthesis](); [Glow-TTS (2020)](../2020.05_Glow-TTS/2020.05_Glow-TTS.md); [HiFi-GAN (2020)](../2020.10_HiFi-GAN/2020.10_HiFi-GAN.md)).
...
> Similar to [Flowtron (2020)](../2020.05_Flowtron/2020.05_Flowtron.md), all samples here were generated from a sentence “How much variation is there?”.
...
与 [Flowtron (2020)](../2020.05_Flowtron/2020.05_Flowtron.md) 类似, 这里所有的样本都来自于一句话 "How much variation is there?".
