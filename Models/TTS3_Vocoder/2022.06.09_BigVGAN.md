...
> [Parallel WaveGAN](2019.10.25_Parallel_WaveGAN.md) extends the single short-time Fourier transform (STFT) loss {ping2018clarinet} to multi-resolution, and adds it as an auxiliary loss for GAN training.
