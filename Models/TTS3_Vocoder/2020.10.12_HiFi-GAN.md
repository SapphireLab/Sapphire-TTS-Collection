...
> 1. predicting a low resolution intermediate representation such as mel-spectrograms (Shen et al., 2018, Ping et al., 2017, Li et al., 2019) or linguistic features ([Oord et al.(WaveNet·2016)](../2016.09.12_WaveNet/2016.09_WaveNet.md)) from text, 
> 2. synthesizing raw waveform audio from the intermediate representation ([Oord et al.(WaveNet·2016)](../2016.09.12_WaveNet/2016.09_WaveNet.md), Prenger et al., 2019, Kumar et al., 2019).
>
...
> [WaveNet (2016)](../2016.09.12_WaveNet/2016.09_WaveNet.md) is an autoregressive (AR) convolutional neural network that demonstrates the ability of neural network based methods to surpass conventional methods in quality..
