...
Discretizing speech into `tokens` has prevailed in speech generative tasks, such as text-to-speech (TTS) (VQTTS; [VALL-E [2]](../Speech_LLM/2023.01.05_VALL-E.md); [UniCATS [3]](../Diffusion/2023.06.13_UniCATS.md); [FACodec [4]](../Speech_Neural_Codec/2024.03.05_FACodec.md)), in the era of large language models (LLMs).
