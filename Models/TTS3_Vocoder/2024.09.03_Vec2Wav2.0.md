...
> In the frontend module, the prompt embeddings are utilized by the position-agnostic cross-attention mechanism ([UniCATS [3]](../_tmp/UniCATS.md); li2024sef), which does not apply positional encoding to the query sequence.
...
> Other hyper-parameters follow CTX-vec2wav ([UniCATS [3]](../_tmp/UniCATS.md)).
