...
While zero-shot speech conversion models can function with shorter voice samples ([^10]; [VALL-E](../SpeechLM/ST2S/2023.01.05_VALL-E.md-E.md)[^11]), they fail to address and capture the essence of singing, particularly expressiveness and musicality.
...
Models such as ([^10]; [VALL-E](../SpeechLM/ST2S/2023.01.05_VALL-E.md-E.md)[^11]; [NaturalSpeech2](../Diffusion/2023.04.18_NaturalSpeech2.md)[^19]) learn such disentanglement through conditional synthesis with large-scale data training.
