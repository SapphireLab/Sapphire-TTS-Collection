...
- 文件:
  - [ArXiv](_PDF/2309.03199v2__Matcha-TTS__A_Fast_TTS_Architecture_with_Conditional_Flow_Matching.pdf)
  - [Publication](_PDF/2309.03199p0__Matcha-TTS__ICASSP2024.pdf)
...
DPM-based methods like [Diff-TTS](../TTS2_Acoustic/2021.04.03_Diff-TTS.md) and [ProDiff](../Diffusion/2022.07.13_ProDiff.md) likewise use 1D convolutions to synthesise mel spectrograms.
