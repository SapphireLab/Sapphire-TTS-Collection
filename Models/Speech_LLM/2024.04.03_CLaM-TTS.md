...
- 机构:
  - [KRAFRON](../../Institutions/KRAFRON.AI.md)
- 时间:
...
> An [RQ-VAE (2022)](../_tmp/2022.03_RQ-VAE.md) is a neural network architecture representing data as discrete codes using residual vector quantization. 
