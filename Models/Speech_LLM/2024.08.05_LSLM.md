...
- 对比:
  ...
  - [VQ-Wav2Vec [02]](../Speech_Representaion/2019.10.12_VQ-Wav2Vec.md) + LSLM (Listening + Speaking) + [CTX-vec2wav](../_tmp/UniCATS.md);
...
一个基于 GAN 的离散 Token 到语音波形的解码器 ([UniCATS [12]](../_tmp/UniCATS.md) 中的 CTX-vec2wav) 用于恢复离散音频 Token 到语音波形.
...
使用 [UniCATS [12]](../_tmp/UniCATS.md) 中的 LibriTTS-testsetB 用于测试, 包括了 $500$ 条来自 37 个未见过的说话人的发言, 是 LibriTTS test-clean 的子集.
