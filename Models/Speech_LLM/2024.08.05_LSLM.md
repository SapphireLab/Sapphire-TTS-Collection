...
> Background noise is uniformly sourced from the Freesound portion of the [MUSAN dataset [34]](../../Datasets/MUSAN.md), which includes high-frequency noise such as telephone ringing and sounds of the explosion, as well as low-frequency noise such as white noise and traffic noise. 
