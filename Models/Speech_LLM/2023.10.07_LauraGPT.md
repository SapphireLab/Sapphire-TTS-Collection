...
>
> To overcome the drawbacks of existing \textit{unified audio-and-text LLMs}, we propose ***LauraGPT***, a novel **unified Audio-and-Text LLM** based on the GPT framework for audio recognition, understanding, and generation.
...
> The encoder and the \textit{first RVQ quantizer} are used as the audio tokenizer, and **the outputs of the first quantizer are used as the audio tokens**.
