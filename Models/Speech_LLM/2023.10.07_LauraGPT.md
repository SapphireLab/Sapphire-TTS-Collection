...
- 机构:
  - [阿里巴巴达摩院](../../Institutions/CHN-Alibaba.md)
- 时间:
...
> LLMs such as [GPT-4](../LLM/GPT-4.md), [PaLM2](../LLM/2023.05.17_PaLM2.md), [LLaMA](../LLM/2023.02.27_LLaMA.md) have demonstrated impressive capabilities across various domains, exhibiting zero-shot generalization without the need for task-specific fine-tuning.
...
> - **Audio-to-Text LLMs** ([Whisper](2022.12.06_Whisper.md); [USM](2023.03.02_USM.md); [Pengi](2023.05.19_Pengi.md); [UniverSLU](2023.10.04_UniverSLU.md); [SALMONN](2023.10.20_SALMONN.md); [Qwen-Audio](2023.11.14_Qwen-Audio.md)), which can convert audio input into text and perform tasks such as automatic speech recognition (ASR) and spoken language understanding (SLU); 
> - **Text-to-Audio LLMs** ([UniAudio](2023.10.01_UniAudio.md); [Audiobox](2023.12.25_Audiobox.md); [AudioGen](2022.09.30_AudioGen.md); [AudioLDM2](../Diffusion/2023.08.10_AudioLDM2.md); [Make-An-Audio](../Diffusion/2023.01.30_Make-An-Audio.md); [VALL-E](2023.01.05_VALL-E.md)), which can convert text input into audio and perform tasks such as text-to-speech synthesis (TTS) and text-to-music synthesis.
...
> Moreover, recent advances in audio generation from unified audio-and-text LLMs ([VALL-E](2023.01.05_VALL-E.md))\citep{DBLP:journals/corr/abs-2305-16107} discretize speech into codec codes, then use an autoregressive language model (LM) to predict output tokens from the first quantizer and use a non-autoregressive model to predict tokens from the other quantizers individually.
...
> [Whisper](2022.12.06_Whisper.md) and [USM](2023.03.02_USM.md) can perform speech recognition and translation across multiple languages and domains.
> [Pengi](2023.05.19_Pengi.md) is an audio LM that formulates audio tasks as text-generation tasks.
...
> In the second category, discrete codec tokens are employed as audio representations and generated by diffusion models~\citep{DBLP:journals/taslp/YangYWWWZY23} or autoregressive LMs ([AudioGen](2022.09.30_AudioGen.md); [AudioLM](2022.09.07_AudioLM.md); [MusicGen](2023.06.08_MusicGen.md); [VALL-E](2023.01.05_VALL-E.md)). 
> Among models in the second category, in models such as [AudioGen](2022.09.30_AudioGen.md), [AudioLM](2022.09.07_AudioLM.md), and [MusicGen](2023.06.08_MusicGen.md), multiple output heads are used after the LM to predict synchronized or delayed groups of codec tokens. 
> However, this mechanism is only suitable for audio generation and may not be applicable to diverse audio-and-text tasks. 
> Alternatively, in [VALL-E](2023.01.05_VALL-E.md), the LM predicts output tokens of the first quantizer, while tokens of the remaining quantizers are predicted by a non-autoregressive model one by one.
