...
- 链接:
  ...
  - [Publication]()
  - [Github]()
  - [Demo](https://sounddemos.github.io/lcm-svc/)
- 文件:
  - [ArXiv:2408.12354v1](_PDF/2024.08.22_2408.12354v1__LCM-SVC__Latent_Diffusion_Model_Based_Singing_Voice_Conversion_with_Inference_Acceleration_via_Latent_Consistency_Distillation.pdf)
  - [Publication] #TODO
...
Audio samples are available at [Github.IO](https://sounddemos.github.io/lcm-svc/).
...
Unlike singing voice synthesis [^Gu2021ByteSing], [^Cui2024Sifisinger], SVC does not require the input of musical scores or lyrics and  it can be accomplished with just singing voice input.
...
<a id="alg:training">Consistency Distillation of LCM-SVC.</a>

<a id="alg:infer">Multi-step Inference of LCM-SVC.</a>
...
<a id="obj">
Objective metrics of different methods.
The suffix 'S' represents the Seen Singer scenario, while the suffix 'U' represents the Unseen Singer scenario.
</a>
...
[^Liu2021Diff{SVC]: Diff{SVC}: A Diffusion Probabilistic Model for Singing Voice Conversion. 2021 IEEE Automatic Speech Recognition and Understanding Workshop (ASRU) 2021.
[^Lu2024CoMoSVC]: CoMoSVC: Consistency Model-Based Singing Voice Conversion. arXiv:2401.01792.
[^Chen2024Ldm-Svc]: {LDM-SVC: Latent Diffusion Model Based Zero-Shot Any-to-Any Singing Voice Conversion With Singer Guidance}. arXiv:2406.05325.
[^Song2020Denoising]: Denoising Diffusion Implicit Models. arXiv:2010.02502.
[^Lu2022DPM-Solver]: DPM-Solver: A Fast Ode Solver for Diffusion Probabilistic Model Sampling in Around 10 Steps. Advances in Neural Information Processing Systems 2022.
[^Song2023Consistency]: Consistency Models. Proceedings of the 40th International Conference on Machine Learning 2023.
[^Luo2023Latent]: Latent Consistency Models: Synthesizing High-Resolution Images With Few-Step Inference. arXiv:2310.04378.
