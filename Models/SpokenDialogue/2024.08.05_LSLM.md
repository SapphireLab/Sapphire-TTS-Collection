...
Some studies ([GSLM [19]](../SpeechLM/2021.02.01_GSLM.md); [pGSLM [17]](../SpeechLM/2021.09.07_pGSLM.md); [dGSLM [26]](../SpokenDialogue/2022.03.30_dGSLM.md)) utilizes this paradigm for speech continuation, generating expressive speech and natural multi-round dialogue.
Other research employs this paradigm to task-specific applications, such as decoder-only high-fidelity TTS ([VALL-E [40]](../SpeechLM/2023.01.05_VALL-E.md); [AudioLM [03]](../SpeechLM/2022.09.07_AudioLM.md); [Seed-TTS [31]](2024.06.04_Seed-TTS.md); [CosyVoice [13]](2024.07.07_CosyVoice.md)) and decoder-only streaming ASR ([Speech ReaLLM [33]](2024.06.13_Speech_ReaLLM.md); [Tsunoo et al.[38]](../ASR/2024.06.23_Decoder-only_Architecture_for_Streaming_E2E_Speech_Recognition.md); [Chen et al.[04]](../ASR/2024.06.27_Streaming_Decoder-Only_ASR_with_Discrete_Speech_Units.md); [BESTOW [08]](2024.06.28_BESTOW.md))
Moreover, [SpeechGPT [48]](../SpokenDialogue/2023.05.18_SpeechGPT.md) and [LauraGPT [05]](../SpeechLM/2023.10.07_LauraGPT.md) initialize SLMs using LLMs, expanding speech tokens to the LLM vocabulary and continuing training on speech.
...
- 一些研究 ([GSLM [19]](../SpeechLM/2021.02.01_GSLM.md); [pGSLM [17]](../SpeechLM/2021.09.07_pGSLM.md); [dGSLM [26]](../SpokenDialogue/2022.03.30_dGSLM.md)) 利用这一范式进行语音续写, 生成富有表现力的语音和自然的多轮对话.
...
- 此外, [SpeechGPT [48]](../SpokenDialogue/2023.05.18_SpeechGPT.md) 和 [LauraGPT [05]](../SpeechLM/2023.10.07_LauraGPT.md) 使用 LLM 初始化 SLM, 将语音 Token 扩展到 LLM 词汇表, 并在语音上继续训练.
...
Similarly, simplex SLMs have demonstrated robust generation capabilities, as seen in LLM-based TTS ([LLM&VALL-E [15]](2023.12.30_LLM&VALL-E.md), [T5-TTS [25]](2024.06.25_T5-TTS.md); [BASE TTS [18]](../SpeechLM/2024.02.12_BASE-TTS.md); [Seed-TTS [31]](2024.06.04_Seed-TTS.md)).
Some research leverages the powerful in-context learning capabilities of LLMs to extend task-specific abilities to more universal applications, such as speech understanding ([Wav2Prompt [11]](2024.06.01_Wav2Prompt.md)), audio understanding ([LTU [14]](../SpeechLM/2023.05.18_LTU.md)), or both ([SALMONN [35]](../SpokenDialogue/2023.10.20_SALMONN.md); [Qwen-Audio [09]](2023.11.14_Qwen-Audio.md); [Qwen2-Audio [10]](../SpokenDialogue/2024.07.15_Qwen2-Audio.md)).
...
Prominent models include [SpeechGPT [48]](../SpokenDialogue/2023.05.18_SpeechGPT.md), [LauraGPT [05]](../SpeechLM/2023.10.07_LauraGPT.md), and [VioLA [42]](../SpeechLM/2023.05.25_VioLA.md).
...
类似地, 单工 SLMs 也展现出了稳健的生成能力, 如基于 LLM 的 TTS: [LLM&VALL-E [15]](2023.12.30_LLM&VALL-E.md), [T5-TTS [25]](2024.06.25_T5-TTS.md); [BASE TTS [18]](../SpeechLM/2024.02.12_BASE-TTS.md); [Seed-TTS [31]](2024.06.04_Seed-TTS.md).

一些研究利用 LLMs 强大的上下文学习能力以扩展具体任务的能力到更通用的应用, 例如语音理解 ([Wav2Prompt [11]](2024.06.01_Wav2Prompt.md)), 音频理解 ([LTU [14]](../SpeechLM/2023.05.18_LTU.md)) 或两者兼有  ([SALMONN [35]](../SpokenDialogue/2023.10.20_SALMONN.md); [Qwen-Audio [09]](2023.11.14_Qwen-Audio.md); [Qwen2-Audio [10]](../SpokenDialogue/2024.07.15_Qwen2-Audio.md)).

尽管单工 SLM 在功能和灵活性方面不断增强, 但它们仅限于单向通信 (从人类到机器或从机器到人类).
LLM 促进了从单工模型到半双工模型 (回合制模型) 的范式变化.
突出的模型包括 [SpeechGPT [48]](../SpokenDialogue/2023.05.18_SpeechGPT.md), [LauraGPT [05]](../SpeechLM/2023.10.07_LauraGPT.md), [VioLA [42]](../SpeechLM/2023.05.25_VioLA.md).
...
Unlike [VALL-E](../SpeechLM/2023.01.05_VALL-E.md)-styled models that combine autoregressive (AR) and non-autoregressive (NAR) approaches with multi-layer residual vector quantization (RVQ) tokens, our model employs a single layer of discrete audio tokens.
...
The word error rate (WER) comparing the generated speech to the original text is considered as the TTS capability evaluation metrics using [Whisper [30]](../SpeechLM/2022.12.06_Whisper.md) [large v3](https://github.com/openai/whisper).
