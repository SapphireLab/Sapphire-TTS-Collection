...
**协作系统** (如 [ParalinGPT](2023.12.23_ParalinGPT.md), [E-Chat](2023.12.31_E-chat.md), 和 [Spoken-LLM](2024.02.20_Spoken-LLM.md)) 引入了副语言特征 (如情感) 来增强对声学信息的理解.
这些系统可以和风格可控的文本转语音系统结合以生成具有特定情感, 语速, 音量等的响应.
在风格可控的文本转语音方面已经有了显著的进步, 如 [Salle (TextrolSpeech)](../../Datasets/2023.08.28_TextrolSpeech.md), [PromptTTS](../Acoustic/2022.11.22_PromptTTS.md), [PromptTTS2](../Acoustic/2023.09.05_PromptTTS2.md), [InstructTTS](../Acoustic/2023.01.31_InstructTTS.md), 和 [ControlSpeech](../SpeechLM/2024.06.03_ControlSpeech.md).

和这些协作系统不同, [Moshi](2024.09.17_Moshi.md) 使用了具有一个单独的演员超过 70 种说话风格的声音和录制的独白的 TTS 引擎来合成训练数据, 以支持端到端模型的理解和生成声学信息.
[GLM-4-Voice](2024.12.03_GLM-4-Voice.md) 采用高质量的多轮口语对话, 针对特定说话风格需求 (如语速, 情感, 方言) 进行了优化, 以支持风格可控的口语对话.
然而, 到目前为止, 先前的工作都没有表明对齐多模态模型能够支持风格可控的声音生成.

之前的对齐多模态模型 (如 LLaMA-Omni 和 Freeze-Omni) 只允许语言模型控制语音内容, 而不控制风格和语调 ([GLM-4-Voice](2024.12.03_GLM-4-Voice.md)), 在本文中, 我们为对齐多模态模型提出了一个新的流式语音解码器并发现这一解码器增强了指令跟随能力, 并使得 ***MinMo*** 能够生成对应于用户指定的情感, 方言, 语速, 以及模仿特定声音的语音.
