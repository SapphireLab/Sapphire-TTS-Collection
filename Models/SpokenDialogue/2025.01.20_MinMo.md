...
- 原生多模态模型, 如 [Moshi](2024.09.17_Moshi.md) 和 [GLM-4-Voice](2024.12.03_GLM-4-Voice.md)
  ...
  - 缺点: 它们有两个主要的局限性.
    ...
    - 与文本相比, 语音数据稀缺, 导致语音-文本训练数据的高度失衡, 从而导致灾难性遗忘 ([Freeze-Omni](../SpokenDialogue/2024.11.01_Freeze-Omni.md)).
- 对齐多模态模型, 如 [LLaMA-Omni](2024.09.10_LLaMA-Omni.md) 和 [Freeze-Omni](../SpokenDialogue/2024.11.01_Freeze-Omni.md)
...
与如 PSLM 这样的协作系统不同, 端到端框架直接接受音频输入并生成音频输出.
[LLaMA-Omni](2024.09.10_LLaMA-Omni.md) 和 [Mini-Omni](../SpokenDialogue/2024.08.27_Mini-Omni.md) 是两个近期的端到端框架, 但还没有针对全双工通信进行训练.
