...
Classical works such as [LLaVA](../CV/LLaVA.md), [Flamingo](../CV/Flamingo.md) and [BLIP](../_Basis/BLIP.md) are used for visual understanding, while in the audio domain, models like [Whisper](../SpeechLM/2022.12.06_Whisper.md) and [Beats](../SpeechRepresentation/2022.12.18_BEATs.md) are commonly utilized as encoders for semantic and acoustic features.
...
[VITA](../SpokenDialogue/2024.08.09_VITA.md), [Qwen2-Audio](2024.07.15_Qwen2-Audio.md) are two models that support voice input, but they output text and rely on external TTS systems for speech synthesis. ***Mini-Omni*** is a fully end-to-end speech-to-speech conversational model.
