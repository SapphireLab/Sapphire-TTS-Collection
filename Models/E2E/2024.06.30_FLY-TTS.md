...
\textbf{MB-iSTFT-base}: Follow the official implementation of iSTFT-VITS\footnote{https://github.com/MasayaKawamura/MB-iSTFT-VITS} with multi-band configuration,
the number of sub-bands is 4, the \textit{nfft} off iSTFT is 16, and the \textit{hop length} is 4.
