...
\label{sec:wavlm}
Pre-trained large speech models have been proven to contain rich acoustic and semantic information,
facilitating high-quality speech synthesis \cite{valle, Audiolm}.
...
This brings two benefits: 1) it can use the rich acoustic and semantic information learned by the self-supervised model to update the generator,
and 2) it can avoid impacting the model size and inference speed of the generator.
