...
> Experiments on the [LJSpeech](../../Datasets/LJSpeech.md) dataset show that ***FLY-TTS*** achieves a real-time factor of 0.0139 on Intel Core i9 CPU, 8.8 times faster than the baseline system (0.1221), and the parameters are compressed by 1.6 times.
...
> We evaluate ***FLY-TTS*** on [LJSpeech](../../Datasets/LJSpeech.md) dataset, which contains 13100 English audio clips and corresponding text transcripts.
