...
As a decoder, we use a stack of 4 affine coupling layers [^21] each layer is itself a stack of 4 **WaveNet** residual blocks[^22], as in **VITS** model.
...
The Posterior Encoder consists of 16 non-causal WaveNet residual blocks [^25], **Glow-TTS**[^20].
...
For efficient end-to-end vocoder training, we randomly sample constant length partial sequences from $z$ as in[^23], [^27], [^28], **VITS**[^19].
...
[^24]: kingma2013auto
[^25]: prenger2019waveglow
[^26]: xin21_interspeech
[^27]: binkowski2019high
[^28]: ren2020fastspeech
[^29]: heo2020clova
[^30]: chung2020in
