...
> Therefore, the LoRA \cite{hu2021LoRA} plugin method has emerged. 
...
>
> We explored using the current mainstream VITS2 model \cite{kong2023vits2}. 
...
>
> The VITS2 \cite{kong2023vits2} model utilizes GAN \cite{creswell2018generative} mechanisms during training. 
...
> In the VITS2 model \cite{kong2023vits2}, linear layers and 1D convolutional layers are primarily used. 
