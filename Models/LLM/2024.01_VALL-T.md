...
> In our experiments, we leverage our [Encodec (2022)](../LLM3_Codec2Wav/2022.10_EnCodec.md) (Defossez et al., 2022) speech tokenizer whose frame shift is 20ms and the sampling rate of output waveforms is 16k.
...
> Before assessing the performance of our models, we conduct speech resynthesis using our [Encodec (2022)](../LLM3_Codec2Wav/2022.10_EnCodec.md) to evaluate the speech tokenizer.
...
> Then, we convert all the 8 RVQ indices to waveform using the [Encodec (2022)](../LLM3_Codec2Wav/2022.10_EnCodec.md) decoder.
