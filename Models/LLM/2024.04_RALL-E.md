...
> The speech tokens here are extracted from [EnCodec (2022)](../LLM3_Codec2Wav/2022.10_EnCodec.md), a neural audio codec based on residual vector quantization (RVQ) [34] that can convert continuous speech signal into discrete tokens.
