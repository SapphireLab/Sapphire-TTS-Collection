...
[^Le2023Voicebox]: Voicebox: Text-Guided Multilingual Universal Speech Generation at Scale. 
[^Casanova2023YourTTS]: YourTTS: Towards Zero-Shot Multi-Speaker TTS and Zero-Shot Voice Conversion for Everyone. 
[^Li2024Sef-Vc]: SEF-VC: Speaker Embedding Free Zero-Shot Voice Conversion With Cross Attention. 
[^Hsu2021HuBERT]: HuBERT: Self-Supervised Speech Representation Learning by Masked Prediction of Hidden Units. 
...
[^Baas2023Voice]: Voice Conversion With Just Nearest Neighbors. 
[^Popov2022Diffusion-Based]: Diffusion-Based Voice Conversion With Fast Maximum Likelihood Sampling Scheme. 
[^Kim2025AdaptVC]: AdaptVC: High Quality Voice Conversion With Adaptive Learning. 
[^Yao2024StableVC]: StableVC: Style Controllable Zero-Shot Voice Conversion With Conditional Flow Matching. 
[^Liu2024Zero-Shot]: Zero-Shot Voice Conversion With Diffusion Transformers. 
[^Zuo2025Enhancing]: Enhancing Expressive Voice Conversion With Discrete Pitch-Conditioned Flow Matching Model. 
[^Maiti2024Voxtlm]: Voxtlm: Unified Decoder-Only Models for Consolidating Speech Recognition, Synthesis and Speech, Text Continuation Tasks. ICASSP 2024-2024 IEEE International Conference on Acoustics, Speech and Signal Processing (ICASSP) 2024.
[^Communication2023SeamlessM4T]: SeamlessM4T: Massively Multilingual \& Multimodal Machine Translation. 
[^Chen2024Towards]: Towards Robust Speech Representation Learning for Thousands of Languages. 
...
[^Wang2021VoxPopuli]: VoxPopuli: A Large-Scale Multilingual Speech Corpus for Representation Learning, Semi-Supervised Learning and Interpretation. 
[^Bhogale2022Effectiveness]: Effectiveness of Mining Audio and Text Pairs From Public Data for Improving ASR Systems for Low-Resource Languages. 
[^Ardila2020Common]: Common Voice: A Massively-Multilingual Speech Corpus. 
[^Lee2023BigVGAN]: BigVGAN: A Universal Neural Vocoder With Large-Scale Training. 
...
[^Choi2023Diff-HierVC]: Diff-HierVC: Diffusion-Based Hierarchical Voice Conversion With Robust Pitch Generation and Masked Prior for Zero-Shot Speaker Adaptation. 