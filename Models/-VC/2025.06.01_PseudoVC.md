...
In this work, we first analyze the mismatch problem between training and inference in the one-shot voice conversion task.

Then we propose a novel training strategy combining *Pseudo Conversion* and *Speaker Sampling* to mitigate the mismatch problem.

Finally we verify the effectiveness of our proposed method, which outperforms previous methods.

It is important to note that our method employs a two-stage training process, as the teacher voice conversion model must be trained initially.

In future work, we aim to explore the development of a one-stage training framework.
...
[^Shan2024Phoneme]: Phoneme Hallucinator: One-Shot Voice Conversion via Set Expansion. Proceedings of the AAAI Conference on Artificial Intelligence 2024.
...
[^Wang2024Gr0]: GR0: Self-Supervised Global Representation Learning for Zero-Shot Voice Conversion. ICASSP 2024-2024 IEEE International Conference on Acoustics, Speech and Signal Processing (ICASSP) 2024.
...
[^Tian2018Average]: Average Modeling Approach to Voice Conversion With Non-Parallel Data.. Odyssey 2018.
[^Lorenzo-Trueba2018Voice]: The Voice Conversion Challenge 2018: Promoting Development of Parallel and Nonparallel Methods. arXiv:1804.04262.
...
[^Bengio2015Scheduled]: Scheduled Sampling for Sequence Prediction With Recurrent Neural Networks. Advances in Neural Information Processing Systems 2015.
[^Jaitly2013Vocal]: Vocal Tract Length Perturbation (VTLP) Improves Speech Recognition. Proc. ICML Workshop on Deep Learning for Audio, Speech and Language 2013.
...
[^Rezende2015Variational]: Variational Inference With Normalizing Flows. International Conference on Machine Learning 2015.
...
[^Prenger2019Waveglow]: Waveglow: A Flow-Based Generative Network for Speech Synthesis. ICASSP 2019-2019 IEEE International Conference on Acoustics, Speech and Signal Processing (ICASSP) 2019.
...
[^Sohn2020Fixmatch]: Fixmatch: Simplifying Semi-Supervised Learning With Consistency and Confidence. Advances in Neural Information Processing Systems 2020.
[^Zhang2022Censer]: Censer: Curriculum Semi-Supervised Learning for Speech Recognition Based on Self-Supervised Pre-Training. arXiv:2206.08189.
[^Arazo2020Pseudo-Labeling]: Pseudo-Labeling and Confirmation Bias in Deep Semi-Supervised Learning. 2020 International Joint Conference on Neural Networks (IJCNN) 2020.
[^Veaux2017CSTR]: CSTR VCTK Corpus: English Multi-Speaker Corpus for CSTR Voice Cloning Toolkit. 
[^Zen2019Libritts]: Libritts: A Corpus Derived From Librispeech for Text-to-Speech. arXiv:1904.02882.
[^Zhang2024Amphion]: Amphion: An Open-Source Audio, Music and Speech Generation Toolkit. arXiv.
...
[^Wan2018Generalized]: Generalized End-to-End Loss for Speaker Verification. 2018 IEEE International Conference on Acoustics, Speech and Signal Processing (ICASSP) 2018.
