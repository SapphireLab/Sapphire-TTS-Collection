...
<a id="tab:baselines">Comparison of baseline models and ours with number of parameters and training hours.
The parentheses next to parameters indicate the number of parameters pre-trained models they utilized.
The parentheses next to the hour are the total hours spent training the linguistic feature extractor.</a>
...
\vfill\pagebreak
\newpage
\bibliographystyle{IEEEbib_abbrev}
{\footnotesize
\bibliography{main}}
