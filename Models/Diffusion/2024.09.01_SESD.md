...
> Previous work has utilized symmetric weightings like the V-Weighting or unimodal distributions centered around moderate noise levels (kingma2023understanding, [VoiceBox [1]](../Speech_LLM/2023.06.23_VoiceBox.md)). 
...
>
> We use a transformer backbone ([Transformer [14]](../_Transformer/2017.06.12_Transformer.md); Peebles2022DiT) with 8 layers and a dimension of 512. 
...
> To condition the diffusion network on the level of noise, we utilize $\alpha$-conditioning ([WaveGrad](../TTS3_Vocoder/2020.09.02_WaveGrad.md); chen2023importance). 
