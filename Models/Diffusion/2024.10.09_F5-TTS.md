...
Recent research in Text-to-Speech (TTS) has experienced great advancement ([Tacotron2 [1]](../TTS2_Acoustic/2017.12.16_Tacotron2.md); [Transformer-TTS [2]](../TTS2_Acoustic/2018.09.19_TransformerTTS.md); [FastSpeech 2 [3]](../TTS2_Acoustic/2020.06.08_FastSpeech2.md); [Glow-TTS [4]](../TTS2_Acoustic/2020.05.22_Glow-TTS.md); [VITS [5]](../E2E/2021.06.11_VITS.md); [Grad-TTS [6]](../TTS2_Acoustic/2021.05.13_Grad-TTS.md); [VioLA [7]](../Speech_LLM/2023.05.25_VioLA.md); [NaturalSpeech [8]](../E2E/2022.05.09_NaturalSpeech.md)).
With a few seconds of audio prompt, current TTS models are able to synthesize speech for any given text and mimic the speaker of audio prompt ([VALL-E [9]](../Speech_LLM/2023.01.05_VALL-E.md); [VALL-E X [10]](../Speech_LLM/2023.03.07_VALL-E_X.md)).
The synthesized speech can achieve high fidelity and naturalness that they are almost indistinguishable from human speech ([NaturalSpeech 2 [11]](2023.04.18_NaturalSpeech2.md); [NaturalSpeech 3 [12]](2024.03.05_NaturalSpeech3.md); [VALL-E 2 [13]](../Speech_LLM/2024.06.08_VALL-E2.md); [Voicebox [14]](../Speech_LLM/2023.06.23_VoiceBox.md)).

While autoregressive (AR) based TTS models exhibit an intuitive way of consecutively predicting the next token(s) and have achieved promising zero-shot TTS capability, the inherent limitations of AR modeling require extra efforts addressing issues such as inference latency and exposure bias ~\cite{[ELLA-V [15]](../Speech_LLM/2024.01.14_ELLA-V.md); vallt,valler,ralle,voicecraft}.
...
Thus, there have been studies exploring direct modeling in continuous space~\cite{ardittts,ar-wovq,[MELLE [29]](../Speech_LLM/2024.07.11_MELLE.md)} to enhance synthesized speech quality recently.
...
In particular, Flow Matching with Optimal Transport path (FM-OT)~\cite{cfm-ot} is widely used in recent research fields not only text-to-speech~\cite{[Voicebox [14]](../Speech_LLM/2023.06.23_VoiceBox.md),voiceflow,matchatts,[DiTTo-TTS [35]](2024.06.17_DiTTo-TTS.md); [E2 TTS [36]](../Flow/2024.06.26_E2_TTS.md)} but also image generation~\cite{sd3} and music generation~\cite{fluxmusic}.
...
While [NaturalSpeech 3 [12]](2024.03.05_NaturalSpeech3.md) and [Voicebox [14]](../Speech_LLM/2023.06.23_VoiceBox.md) use frame-wise phoneme alignment; Matcha-TTS \cite{matchatts} adopts monotonic alignment search and relies on phoneme-level duration model; recent works find that introducing such rigid and inflexible alignment between text and speech hinders the model from generating results with higher naturalness ([E2 TTS [36]](../Flow/2024.06.26_E2_TTS.md); [Seed-TTS [39]](../Speech_LLM/2024.06.04_Seed-TTS.md)).
...
In contrast, [E2 TTS [36]](../Flow/2024.06.26_E2_TTS.md), based on [Voicebox [14]](../Speech_LLM/2023.06.23_VoiceBox.md), adopts a simpler way, which removes the phoneme and duration predictor and directly uses characters padded with filler tokens to the length of mel spectrograms as input.
...
[Seed-TTS [39]](../Speech_LLM/2024.06.04_Seed-TTS.md) employs a similar strategy and achieves excellent results, though not elaborated in model details.
...
Following [Voicebox [14]](../Speech_LLM/2023.06.23_VoiceBox.md), we trained our model on the text-guided speech-infilling task.
Based on recent research ([DiTTo-TTS [35]](2024.06.17_DiTTo-TTS.md); [E2 TTS [36]](../Flow/2024.06.26_E2_TTS.md); [E1 TTS [48]](2024.09.14_E1_TTS.md)), it is promising to train without phoneme-level duration predictor and can achieve higher naturalness in zero-shot generation deprecating explicit phoneme-level alignment.
We adopt a similar pipeline as [E2 TTS [36]](../Flow/2024.06.26_E2_TTS.md) and propose our advanced architecture ***F5-TTS***, addressing the slow convergence (timbre learned well at an early stage but struggled to learn alignment) and robustness issues (failures on hard case generation) of E2 TTS.
...
Both models use RoPE as mentioned in Sec.\ref{sec:f5tts}, a dropout rate of 0.1 for attention and FFN, the same convolutional position embedding as in [Voicebox [14]](../Speech_LLM/2023.06.23_VoiceBox.md).
...
We use the Exponential Moving Averaged (EMA)~\cite{ema} weights for inference, and the Euler ODE solver for ***F5-TTS*** (midpoint for E2 TTS as described in [E2 TTS [36]](../Flow/2024.06.26_E2_TTS.md)).
...
- autoregressive models: [VALL-E 2 [13]](../Speech_LLM/2024.06.08_VALL-E2.md), [MELLE [29]](../Speech_LLM/2024.07.11_MELLE.md), FireRedTTS~\cite{fireredtts} and CosyVoice~\cite{cosyvoice};
- non-autoregressive models: [Voicebox [14]](../Speech_LLM/2023.06.23_VoiceBox.md), [NaturalSpeech 3 [12]](2024.03.05_NaturalSpeech3.md), [DiTTo-TTS [35]](2024.06.17_DiTTo-TTS.md), MaskGCT~\cite{maskgct}, [Seed-TTS$_{DiT}$ [39]](../Speech_LLM/2024.06.04_Seed-TTS.md) and our reproduced [E2 TTS [36]](../Flow/2024.06.26_E2_TTS.md).
...
For WER, we employ Whisper-large-v3~\cite{whisper} to transcribe English and Paraformer-zh~\cite{funasr} for Chinese, following [Seed-TTS [39]](../Speech_LLM/2024.06.04_Seed-TTS.md).
...
A robustness test on [ELLA-V [15]](../Speech_LLM/2024.01.14_ELLA-V.md) hard sentences is further included in Appendix \ref{appx:ellavhardtest}.
