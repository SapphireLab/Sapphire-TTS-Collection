...
Although increasing the number of demonstration samples in the prompt and averaging multiple runs can mitigate this issue, it also significantly raises inference costs. (3) ByT5-based predictors and the duration predictor of [FastSpeech2 [2]](../TTS2_Acoustic/2020.06.08_FastSpeech2.md) demonstrate greater stability than AR-based phoneme duration predictors.
