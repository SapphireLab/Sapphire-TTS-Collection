...
[VALL-E](../SpeechLM/2023.01.05_VALL-E.md) employs [EnCodec](../../Models/Speech_Neural_Codec/2022.10.24_EnCodec.md) for speech-to-token mapping, posing TTS tasks as AR language modeling tasks, thus enabling zero-shot capabilities in the speech domain.
...
For the latent space, we employ Mel-VAE introduced in ([CLaM-TTS](../../Models/SpeechLM/2024.04.03_CLaM-TTS.md)) which is able to compress audio sequences approximately seven times more than [EnCodec](../../Models/Speech_Neural_Codec/2022.10.24_EnCodec.md), yet maintaining superior quality.
...
对于隐空间, 我们采用 Mel-VAE ([CLaM-TTS](../../Models/SpeechLM/2024.04.03_CLaM-TTS.md)) 作为替代品, 它能够在音频序列的近似压缩率上比 [EnCodec](../../Models/Speech_Neural_Codec/2022.10.24_EnCodec.md) 提高了 7 倍, 同时保持优秀的质量.
