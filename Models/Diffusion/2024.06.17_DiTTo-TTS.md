...
> Without these components, generation performance tends to be suboptimal ([Simple-TTS](../../Models/_tmp/Simple-TTS.md), [E3-TTS](../_tmp/2023.11.02_E3_TTS.md)), while their inclusion hinders the model efficiency and scalability.
...
> Similarly, [E3-TTS](../_tmp/2023.11.02_E3_TTS.md) follows this approach but does not utilize a pre-trained latent autoencoder.
