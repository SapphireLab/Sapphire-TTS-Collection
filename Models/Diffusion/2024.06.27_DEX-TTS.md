...
Although [U-DiT TTS](../../Models/Diffusion/2023.05.22_U-DiT_TTS.md) used [DiT](DiT.md) for the diffusion network, DiT is yet to be effectively leveraged for TTS.
...
[U-DiT TTS](../../Models/Diffusion/2023.05.22_U-DiT_TTS.md) improved the design of diffusion networks in TTS by adopting [DiT](DiT.md) blocks while retaining some aspects of U-Net down- and up-sampling.
[DiT](DiT.md) can extract detailed representations using attention operations between small patches.
...
[U-DiT TTS](../../Models/Diffusion/2023.05.22_U-DiT_TTS.md) 通过采用 [DiT](DiT.md) 模块, 同时保留 U-Net 下采样和上采样的部分, 改进了文本转语音中扩散网络的设计.
[DiT](DiT.md) 可以利用小块之间的注意力操作提取详细表示.
...
>
The diffusion decoder comprises convolution blocks, adapters, and [DiT](DiT.md) blocks.
