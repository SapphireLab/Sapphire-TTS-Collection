...
- **Audio-to-Text LLMs** (**Whisper**; [USM](../../ASR/2023.03.02_Google_USM.md); [Pengi](../ST2T/2023.05.19_Pengi.md); ../2023.10.04_UniverSLU.mdUniverSLU.md); [SALMONN](../../SpokenDialogue/2023.10.20_SALMONN.md); [Qwen-Audio](../../SpokenDialogue/2023.11.14_Qwen-Audio.md)), which can convert audio input into text and perform tasks such as automatic speech recognition (ASR) and spoken language understanding (SLU);
- **Text-to-Audio LLMs** ([UniAudio](../2023.10.01_UniAudio.md); [Audiobox](2023.12.25_A../2023.12.25_Audiobox.md](ST2S/2022.09../ST2S/2022.09.30_AudioGen.md2](../Diffusion../../Diffusion/2023.08.10_AudioLDM2.mdAudio](../Diffusion../../Diffusion/2023.01.30_Make-An-Audio.md*, which can convert text input into audio and perform tasks such as text-to-speech synthesis (TTS) and text-to-music synthesis.
...
Moreover, recent advances in audio generation from unified audio-and-text LLMs (**VALL-E**; {DBLP:journals/corr/abs-2305-16107}) discretize speech into codec codes, then use an autoregressive language model (LM) to predict output tokens from the first quantizer and use a non-autoregressive model to predict tokens from the other quantizers individually.
...
**Whisper** and [USM](../../ASR/2023.03.02_Google_USM.md) can perform speech recognition and translation across multiple languages and domains.
[Pengi](../ST2T/2023.05.19_Pengi.md) is an audio LM that formulates audio tasks as text-generation tasks.
[UniverSLU](../2023.10.04_UniverSLU.md) is a universal SLU model that supports various speech classification and sequence generation tasks.
[SALMONN](../../SpokenDialogue/2023.10.20_SALMONN.md) and [Qwen-Audio](../../SpokenDialogue/2023.11.14_Qwen-Audio.md) integrate pre-trained text LLMs with separate speech and audio encoders into a single multimodal model.
...
In the second category, discrete codec tokens are employed as audio representations and generated by diffusion models~\citep{DBLP:journals/taslp/YangYWWWZY23} or autoregressive LMs ([AudioGen](../ST2S/2022.09.30_AudioGen.md); [AudioLM](ST2S/20ST2S/2022.09.07_AudioLM.md2023.06.08_MusicGen.md); [VALL-E](../Sp[VST2S/2023.01.05_VALL-E.md)
Among models in the second category, in models such as [AudioGen](../ST2S/2022.09.30_AudioGen.md), [AudioLM](ST2S/20ST2S/2022.09.07_AudioLM.mden](2023.06.08_MusicGen.md), multiple output heads are used after the LM to predict synchronized or delayed groups of codec tokens.
However, this mechanism is only suitable for audio generation and may not be applicable to diverse audio-and-text tasks.
Alternatively, in [VALL-E](ST2S/2023.01.05_VALL-E.mdLM predicts output tokens of the first quantizer, while tokens of the remaining quantizers are predicted by a non-autoregressive model one by one.
...
[VALL-E](ST2S/2023.01.05_VALL-E.mdduces a commonly used scheme formulating audio synthesis as a classification problem: A neural network is shared to predict the codec tokens in the following group with the previous ones as inputs and synthesizing target audio requires multiple steps or iterations to achieve a reasonable speech quality.
