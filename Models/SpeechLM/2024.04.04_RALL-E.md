...
The speech tokens here are extracted from [EnCodec (2022)](../SpeechCodec/2022.10.24_EnCodec.md), a neural audio codec based on residual vector quantization (RVQ) [34] that can convert continuous speech signal into discrete tokens.
