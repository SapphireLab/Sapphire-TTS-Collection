...
However, it still falls short of Qwen2-0.5B-instruct. Although both models are fine-tuned from Qwen2-0.5B-base, Qwen2-0.5B-instruct benefits from extensive text-based instruction tuning, whereas SLAM-Omni relies solely on a 400K spoken-dialogue dataset.
