...
- 链接:
  ...
  - [Publication]()
  - [Github]
    - 2024.08.06 [sanowl/LSLM](https://github.com/sanowl/LSLM-Listening-while-Speaking-Language-Model)
  - [Demo](https://ziyang.tech/LSLM/)
- 文件:
  - [ArXiv](_PDF/2408.02622v1__LSLM__Language_Model_Can_Listen_While_Speaking.pdf)
  - [Publication] #TODO
...
With the rapid development of [GPT-style [29]](../TextLM/2018.06.11_GPT.md) large language models (LLM) and the scaling of [Transformer [39]](../_Transformer/2017.06.12_Transformer.md)-style architectures, textual conversational AI, such as ChatGPT ([InstrcutGPT [27]](../TextLM/InstructGPT.md), [GPT-4 [01]](../TextLM/2023.03.15_GPT-4.md)) and [LLaMA [36]](../TextLM/2023.02.27_LLaMA.md), [LLaMA2 [37]](../TextLM/2023.07.18_LLaMA2.md), have become a significant part of daily life.
...
Some studies ([GSLM [19]](../SpeechLM/S2S/2021.02.01_GSLM.m[pGSLM [17]](../SpeechLM/S2S/2021.09.07_pGSLM.md).md); [dGSLM [26]](../SpokenDialogue/2022.03.30_dGSLM.md)) utilizes this paradigm for speech continuation, generating expressive speech and natural multi-round dialogue.
Other research employs this paradigm to task-specific applications, such as decoder-only high-fidelity TTS ([VALL-E [40]](../SpeechLM/ST2S/2023.01.05_VALL-E.md); [AudioLM [03]](../SpeechLM/ST2S/2022.09.07_AudioLM.md); [Seed-TTS [31]](2024.06.04_Seed-TTS.md); [CosyVoice [13]](2024.07.07_CosyVoice.md)) and decoder-only streaming ASR ([Speech ReaLLM [33]](2024.06.13_Speech_ReaLLM.md); [Tsunoo et al.[38]](../ASR/2024.06.23_Decoder-only_Architecture_for_Streaming_E2E_Speech_Recognition.md); [Chen et al.[04]](../ASR/2024.06.27_Streaming_Decoder-Only_ASR_with_Discrete_Speech_Units.md); [BESTOW [08]](2024.06.28_BESTOW.md))
Moreover, [SpeechGPT [48]](../SpokenDialogue/2023.05.18_SpeechGPT.md) and [LauraGPT [05]](../SpeechLM/ST2ST/2023.10.07_LauraGPT.md) initialize SLMs using LLMs, expanding speech tokens to the LLM vocabulary and continuing training on speech.
...
Other works ([Zhang et al.[49]](Beyond_the_Turn-Based_Game__Enabling_Real-Time_Conversations_with_Duplex_Models.md); [Wang et al.[41]](../SpokenDialogue/2024.05.29_A_Full_Duplex_Speech_Dialogue_Scheme_Based_on_LLMs.md)) suggest modifying the order in which text tokens are organized in the LLM to tackle the duplex modeling problem.
...
- 一些研究 ([GSLM [19]](../SpeechLM/S2S/2021.02.01_GSLM.m[pGSLM [17]](../SpeechLM/S2S/2021.09.07_pGSLM.md).md); [dGSLM [26]](../SpokenDialogue/2022.03.30_dGSLM.md)) 利用这一范式进行语音续写, 生成富有表现力的语音和自然的多轮对话.
- 其他研究则采用这一范式进行特定任务的应用, 如
  - 基于仅解码器架构的高保真文本转语音 ([VALL-E [40]](../SpeechLM/ST2S/2023.01.05_VALL-E.md); [AudioLM [03]](../SpeechLM/ST2S/2022.09.07_AudioLM.md)；[Seed-TTS [31]](2024.06.04_Seed-TTS.md); [CosyVoice [13]](2024.07.07_CosyVoice.md));
...
- 此外, [SpeechGPT [48]](../SpokenDialogue/2023.05.18_SpeechGPT.md) 和 [LauraGPT [05]](../SpeechLM/ST2ST/2023.10.07_LauraGPT.md) 使用 LLM 初始化 SLM, 将语音 Token 扩展到 LLM 词汇表, 并在语音上继续训练.
...
- 其他工作 ([Zhang et al. [49]](Beyond_the_Turn-Based_Game__Enabling_Real-Time_Conversations_with_Duplex_Models.md)；[Wang et al. [41]](../SpokenDialogue/2024.05.29_A_Full_Duplex_Speech_Dialogue_Scheme_Based_on_LLMs.md)) 建议修改 LLM 中文本 Token 的组织顺序以解决全双工建模问题.
...
![../SpeechLM/Images/2024.08.05_LSLM_Fig.01.png](../SpeechLM/Images/2024.08.05_LSLM_Fig.01.png)
...
Representative works include LLM-based ASR ([Yu et al. [46]](../ASR/2023.09.25_Connecting_Speech_Encoder_&_LLM_for_ASR.md); [SLAM-ASR [24]](../ASR/2024.02.13_SLAM-ASR.md); [MaLa-ASR [45]](../ASR/2024.06.09_MaLa-ASR.md); [Seed-ASR [32]](../ASR/2024.07.05_Seed-ASR.md)), LLM-based speech translation ([COSMIC [28]](../SpeechLM/2023.11.03_COSMIC.md); [SALM [07]](../SpeechLM/2023.10.13_SALM.md); [Huang et al. [16]](Investigating_Decoder-Only_LLMs_for_STT_Translation.md), [LLaST [06]](../SpeechLM/2024.07.22_LLaST.md)), and LLM-based speech emotion understanding ([SECap [44]](../SpeechRepresentation/2023.12.16_SECap.md); [Spoken-LLM [21]](2024.02.20_Spoken-LLM.md); [AffectGPT [20]](../SpeechRepresentation/2024.07.10_AffectGPT.md)).
Similarly, simplex SLMs have demonstrated robust generation capabilities, as seen in LLM-based TTS ([LLM&VALL-E [15]](2023.12.30_LLM&VALL-E.md), [T5-TTS [25]](2024.06.25_T5-TTS.md); [BASE TTS [18]](../SpeechLM/ST2S/2024.02.12_BASE-TTS.md); [Seed-TTS [31]](2024.06.04_Seed-TTS.md)).
Some research leverages the powerful in-context learning capabilities of LLMs to extend task-specific abilities to more universal applications, such as speech understanding ([Wav2Prompt [11]](2024.06.01_Wav2Prompt.md)), audio understanding ([LTU [14]](../SpeechLM/ST2T/2023.05.18_LTU.md)), or both ([SALMONN [35]](../SpokenDialogue/2023.10.20_SALMONN.md); [Qwen-Audio [09]](../SpeechLM/ST2T/2023.11.14_Qwen-Audio.md); [Qwen2-Audio [10]](../SpeechLM/ST2T/2024.07.15_Qwen2-Audio.md)).
...
Prominent models include [SpeechGPT [48]](../SpokenDialogue/2023.05.18_SpeechGPT.md), [LauraGPT [05]](../SpeechLM/ST2ST/2023.10.07_LauraGPT.md), and [VioLA [42]](../SpeechLM/ST2ST/2023.05.25_VioLA.md).
...
- 基于 LLM 的语音情感理解: [SECap [44]](../SpeechRepresentation/2023.12.16_SECap.md); [Spoken-LLM [21]](2024.02.20_Spoken-LLM.md); [AffectGPT [20]](../SpeechRepresentation/2024.07.10_AffectGPT.md);

类似地, 单工 SLMs 也展现出了稳健的生成能力, 如基于 LLM 的 TTS: [LLM&VALL-E [15]](2023.12.30_LLM&VALL-E.md), [T5-TTS [25]](2024.06.25_T5-TTS.md); [BASE TTS [18]](../SpeechLM/ST2S/2024.02.12_BASE-TTS.md); [Seed-TTS [31]](2024.06.04_Seed-TTS.md).

一些研究利用 LLMs 强大的上下文学习能力以扩展具体任务的能力到更通用的应用, 例如语音理解 ([Wav2Prompt [11]](2024.06.01_Wav2Prompt.md)), 音频理解 ([LTU [14]](../SpeechLM/ST2T/2023.05.18_LTU.md)) 或两者兼有  ([SALMONN [35]](../SpokenDialogue/2023.10.20_SALMONN.md); [Qwen-Audio [09]](../SpeechLM/ST2T/2023.11.14_Qwen-Audio.md); [Qwen2-Audio [10]](../SpeechLM/ST2T/2024.07.15_Qwen2-Audio.md)).

尽管单工 SLM 在功能和灵活性方面不断增强, 但它们仅限于单向通信 (从人类到机器或从机器到人类).
LLM 促进了从单工模型到半双工模型 (回合制模型) 的范式变化.
突出的模型包括 [SpeechGPT [48]](../SpokenDialogue/2023.05.18_SpeechGPT.md), [LauraGPT [05]](../SpeechLM/ST2ST/2023.10.07_LauraGPT.md), [VioLA [42]](../SpeechLM/ST2ST/2023.05.25_VioLA.md).
...
Recent efforts ([Zhang et al.[49]](Beyond_the_Turn-Based_Game__Enabling_Real-Time_Conversations_with_Duplex_Models.md); [Wang et al.[41]](../SpokenDialogue/2024.05.29_A_Full_Duplex_Speech_Dialogue_Scheme_Based_on_LLMs.md)) have attempted to build full duplex capabilities on text-centric LLMs with cascade ASR and TTS modules.
...
近期的努力 ([Zhang et al.[49]](Beyond_the_Turn-Based_Game__Enabling_Real-Time_Conversations_with_Duplex_Models.md); [Wang et al.[41]](../SpokenDialogue/2024.05.29_A_Full_Duplex_Speech_Dialogue_Scheme_Based_on_LLMs.md)) 试图在以文本为中心的 LLM 结合级联 ASR 和 TTS 模块构建全双工能力.
...
Unlike [VALL-E](../SpeechLM/ST2S/2023.01.05_VALL-E.md-E.md)-styled models that combine autoregressive (AR) and non-autoregressive (NAR) approaches with multi-layer residual vector quantization (RVQ) tokens, our model employs a single layer of discrete audio tokens.
...
Given target speech $X^R$, an SSL encoder $Enc$ is utilized to obtain a continuous embedding $R$, which can be written as:
...
where $Qnt$ is the discretization operation and $R^q$ are the discrete tokens.
...
不像 [VALL-E](../SpeechLM/ST2S/2023.01.05_VALL-E.md-E.md) 类型的模型用多层残差矢量量化 (RVQ) Token 将自回归方法和非自回归方法结合, 我们的模型采用单层的离散音频 Token.
...
1. 声码器 $Dec$ 用于从离散 Token $\hat{R}^q$ 恢复语音信号 $\hat{X}^R$, 写为:
$$
    \hat{X}^R=Dec(\hat{R}^q, A)
$$
其中 $A$ 是提供合成语音音色的声学提示.
...
Given the audio input $X^S$ of the listening channel, the same SSL encoder $Enc$ in Equation.04 is used to obtain a continuous embedding $S$, which can be written as:

$$
    S = Enc(X^S),
$$

where $X^S$ can be a variety of sound signals, including environmental noise and human speech.
Unlike training the speaking ability, which involves a discretization module, the listening channel embedding $S$ is fed into the neural network end-to-end via a projection module $Proj$, which can be written as:
...
Here we revise Equation.06 as follows:
...
The revised formula from Equation.08 is written as follows:
...
To comprehensively explore the integration of a listening channel to the proposed ***LSLM***, we try to fuse the listening channel and the speaking channel with early, middle, and late methods, as shown in Figure.03.
...
SSL encoder [VQ-Wav2Vec [02]](../SpeechRepresentation/2019.10.12_VQ-Wav2Vec.md) is employed to extract audio features and further convert speech features to discrete tokens.
[VQ-Wav2Vec](../SpeechRepresentation/2019.10.12_VQ-Wav2Vec.md), a fully convolutional self-supervised pre-trained model with $20$ layers of 1D convolutional neural networks with $34$M parameters, is naturally suitable for streaming audio feature extraction.
A simple linear layer serves as the projection module to adapt the listening channel features to the AR model.
A GAN-based token-to-waveform vocoder ([UniCATS [12]](../Diffusion/2023.06.13_UniCATS.md)) is utilized to recover discrete audio tokens to speech waveform.

</details>
<br>

***LSLM*** 的骨干网络是仅解码器的 Transformer 架构, 由 $12$ 个 Transformer 块, $12$ 个注意力头, $768$ 维嵌入维度, 和 $3072$ 维前馈层维度组成, 共计 $106 M$ 参数.
自监督学习编码器采用 [VQ-Wav2Vec [02]](../SpeechRepresentation/2019.10.12_VQ-Wav2Vec.md) 提取音频特征, 并将语音特征转换为离散 Token.
[VQ-Wav2Vec](../SpeechRepresentation/2019.10.12_VQ-Wav2Vec.md) 是一种自监督预训练模型, 它采用 $20$ 层的一维卷积神经网络, 共计 $34 M$ 参数. 它很自然地适合流式音频特征提取.
...
Table.01 summarizes the datasets and experimental settings.
...
LibriTTS-testsetB ([UniCATS [12]](../Diffusion/2023.06.13_UniCATS.md)) is adopted for testing, which contains $500$ utterances sampled from the test-clean subset of LibriTTS with 37 unseen speakers.
...
The word error rate (WER) comparing the generated speech to the original text is considered as the TTS capability evaluation metrics using [**Whisper Large V3**](https://github.com/openai/whisper).
...
使用 [**Whisper Large V3**](https://github.com/openai/whisper) 计算生成语音与原始文本之间的词错误率 (WER) 作为 TTS 能力评估指标.
...
For TTS capability, we use a test set consisting of $500$ utterances, referred to as LibriTTS-testsetB ([UniCATS [12]](../Diffusion/2023.06.13_UniCATS.md)), without any interruptions in the listening channel.
...
For command-based FDM, we test the three architectures described in [Section: FDM Ability](#FDM_Ability) to fuse the listening channel and the speaking channel, which are early fusion (***LSLM***$_{EF}$), middle fusion (***LSLM***$_{MF}$), and late fusion (***LSLM***$_{LF}$).
...
对于基于命令的全双工建模, 我们测试在 [FDM 能力](#FDM_Ability) 描述的三种用于融合听觉通道和说话通道的架构, 即早期融合 ***LSLM***$_{EF}$, 中期融合 ***LSLM***$_{MF}$, 以及后期融合 ***LSLM***$_{LF}$.
...
***LSLM*** 在纯净条件下获得 WER 约为 $5.33\%$, 在噪声条件下获得 WER 约为 $8.50\%$, 与 Vanilla TTS 模型相比, 表明真实世界的轮次转换问题所面临的挑战.
...
As illustrated in Figure.04, the probability of the `IRQ` token remains below $1\times10^{-3}$ when the model is not interrupted.
...
The detailed results are presented in Table.04.
