...
Traditionally, tokens are acquired through unsupervised learning, which may not capture explicit semantic information or align well with corresponding text ([HuBERT (2021)](../SpeechRepresentation/2021.06.14_HuBERT.md); [EnCodec (2022)](../Speech_Neural_Codec/2022.10.24_EnCodec.md)).
