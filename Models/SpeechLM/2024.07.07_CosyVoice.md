...
OT-CFM can achieve better performance compared to diffusion probabilistic models (DPMs) with simpler gradients, easier training and faster generation ([Flow Matching (2022)](../Diffusion/2022.10.06_Flow_Matching.md); [OT-CFM (2023)](../Flow/2023.02.01_OT-CFM.md); [Matcha-TTS (2023)](../Flow/2023.09.06_Matcha-TTS.md)).
