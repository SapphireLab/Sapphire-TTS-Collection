...
- 作者:
  - 01 Xincan Feng
  - 02 Akifumi Yoshimoto
- 链接:
  - [ArXiv](https://arxiv.org/abs/2404.06714)
  - [Publication](https://aclanthology.org/2024.lrec-main.931)
  - [Github](https://github.com/xincanfeng/vitsgpt.git)
  - [Demo](https://xincanfeng.github.io/Llama-VITS_demo/)
- 文件:
  - [ArXiv](_PDF/2404.06714v3__Llama-VITS__Enhancing_TTS_Synthesis_with_Semantic_Awareness.pdf)
  - [Publication](_PDF/2404.06714p0__LLaMA-VITS__LREC2024.pdf)
...
[Tacotron (2017)](../Acoustic/2017.03.29_Tacotron.md) undertakes training from the ground up and directly predicts linear spectrograms.
Furthermore, the speech produced by [Tacotron2 (2017)](../Acoustic/2017.12.16_Tacotron2.md) closely mirrors the natural human voice.
...
[FastSpeech (2019)](../Acoustic/2019.05.22_FastSpeech.md) and its variants exemplify this trend.
[FastSpeech (2019)](../Acoustic/2019.05.22_FastSpeech.md) employs a transformer-based architecture to generate mel-spectrograms in parallel.
Building on [FastSpeech (2019)](../Acoustic/2019.05.22_FastSpeech.md); [FastPitch (2020)](../Acoustic/2020.06.11_FastPitch.md) predicts pitch contours during inference, enabling the production of more expressive and high quality speech.
[FastSpeech2 (2020)](../Acoustic/2020.06.08_FastSpeech2.md) further incorporates explicit duration prediction and introduces pitch and energy as conditional inputs.
