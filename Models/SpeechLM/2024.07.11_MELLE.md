...
[Mega-TTS](../Speech_LLM/2023.06.06_Mega-TTS.md) proposes to disentangle the multiple attributes in speech, such as content, timbre, prosody, and phase attributes, then model each of them according to their intrinsic properties with a language modeling approach.
**ELLA-V (2024)**, [RALL-E](../Speech_LLM/2024.04.04_RALL-E.md), and [VALL-E R](../Speech_LLM/2024.06.12_VALL-E_R.md) aims to improve robustness and stability of VALL-E via additional fine-grained speech-text alignment information.
[BASE TTS](../Speech_LLM/2024.02.12_BASE-TTS.md) employs discrete tokens derived from [WavLM](../Speech_Representaion/2021.10.26_WavLM.md) and scales the codec language model to larger parameters and training data.
[Seed-TTS](../Speech_LLM/2024.06.04_Seed-TTS.md) replaces NAR model in VALL-E with a diffusion model, which generates continuous speech representations according generated speech tokens from AR stage.
...
For instance, [SoundStorm](../Speech_LLM/2023.05.16_SoundStorm.md) adapts a parallel, non-autoregressive, confidence-based decoding scheme for the generation of codec codes.
[StyleTTS2](../Speech_LLM/2023.06.13_StyleTTS2.md) and [NaturalSpeech 3](../Diffusion/2024.03.05_NaturalSpeech3.md) use diffusion model to achieve better TTS synthesis.
[Voicebox](../Speech_LLM/2023.06.23_VoiceBox.md) and [Audiobox](../Speech_LLM/2023.12.25_Audiobox.md) employ non-autoregressive flow-matching based models for transcript-guided speech generation.
...
![](../Speech_LLM/Images/2024.07.11_MELLE_Fig.01.png)
...
Diffusion-based ([NaturalSpeech2](../Diffusion/2023.04.18_NaturalSpeech2.md); [NaturalSpeech3](../Diffusion/2024.03.05_NaturalSpeech3.md)) and flow-matching-based methods ([Voicebox](../Speech_LLM/2023.06.23_VoiceBox.md)) restore speech representations from the sampling of a simpler distribution.
...
![](../Speech_LLM/Images/2024.07.11_MELLE_Fig.02.png)
...
We use a linear layer to project the output of the LM to a logit and calculate the BCE loss, $\mathcal{L}_{\text{stop}}$, for stop prediction, like [TransformerTTS](../TTS2_Acoustic/2018.09.19_TransformerTTS.md) and [SpeechT5](../MultiModal/2021.10.14_SpeechT5.md).
