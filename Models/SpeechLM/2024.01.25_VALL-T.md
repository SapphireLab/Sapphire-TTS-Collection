...
- 文件:
  - [ArXiv](_PDF/2401.14321v4__VALL-T__Decoder-Only_Generative_Transducer_for_Robust_and_Decoding-Controllable_Text-to-Speech.pdf)
  - [Publication] #TODO
...
Mainstream neural text-to-speech models, such as [FastSpeech2](../Acoustic/2020.06.08_FastSpeech2.md); GradTTS (Popov et al., 2021) and VoiceFlow (Guo et al., 2024), integrate a duration prediction module.
...
In our experiments, we leverage our [Encodec (2022)](../SpeechCodec/2022.10.24_EnCodec.md) (Defossez et al., 2022) speech tokenizer whose frame shift is 20ms and the sampling rate of output waveforms is 16k.
...
Before assessing the performance of our models, we conduct speech resynthesis using our [Encodec (2022)](../SpeechCodec/2022.10.24_EnCodec.md) to evaluate the speech tokenizer.
...
Then, we convert all the 8 RVQ indices to waveform using the [Encodec (2022)](../SpeechCodec/2022.10.24_EnCodec.md) decoder.
