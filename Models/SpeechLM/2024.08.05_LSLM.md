...
Some studies ([GSLM [19]](../SpeechLM/2021.02.01_GSLM.md); [pGSLM [17]](../SpeechLM/2021.09.07_pGSLM.md); [dGSLM [26]](../SpeechLM/2022.03.30_dGSLM.md)) utilizes this paradigm for speech continuation, generating expressive speech and natural multi-round dialogue.
...
Moreover, [SpeechGPT [48]](../SpeechLM/2023.05.18_SpeechGPT.md) and [LauraGPT [05]](../SpeechLM/2023.10.07_LauraGPT.md) initialize SLMs using LLMs, expanding speech tokens to the LLM vocabulary and continuing training on speech.
...
Other works ([Zhang et al.[49]](Beyond_the_Turn-Based_Game__Enabling_Real-Time_Conversations_with_Duplex_Models.md); [Wang et al.[41]](2024.05.29_A_Full_Duplex_Speech_Dialogue_Scheme_Based_on_LLMs.md)) suggest modifying the order in which text tokens are organized in the LLM to tackle the duplex modeling problem.
...
Some research leverages the powerful in-context learning capabilities of LLMs to extend task-specific abilities to more universal applications, such as speech understanding ([Wav2Prompt [11]](2024.06.01_Wav2Prompt.md)), audio understanding ([LTU [14]](../SpeechLM/2023.05.18_LTU.md)), or both ([SALMONN [35]](../SpeechLM/2023.10.20_SALMONN.md); [Qwen-Audio [09]](../SpeechLM/2023.11.14_Qwen-Audio.md); [Qwen2-Audio [10]](../SpeechLM/2024.07.15_Qwen2-Audio.md)).
...
Prominent models include [SpeechGPT [48]](../SpeechLM/2023.05.18_SpeechGPT.md), [LauraGPT [05]](../SpeechLM/2023.10.07_LauraGPT.md), and [VioLA [42]](../SpeechLM/2023.05.25_VioLA.md).
...
Recent efforts ([Zhang et al.[49]](Beyond_the_Turn-Based_Game__Enabling_Real-Time_Conversations_with_Duplex_Models.md); [Wang et al.[41]](2024.05.29_A_Full_Duplex_Speech_Dialogue_Scheme_Based_on_LLMs.md)) have attempted to build full duplex capabilities on text-centric LLMs with cascade ASR and TTS modules.
