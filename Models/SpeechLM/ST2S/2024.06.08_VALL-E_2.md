...
Some systems, trained with clean single-speaker speech data recorded in sound-recording studios, have even achieved human-level quality for single-speaker speech generation [^04].
...
Several follow-up works have been proposed to address these problems [^06], [^07], [^08], [^09], [^10].
To improve stability, some works leverage text-speech alignment information in model training and inference [^06], [^07].
...
To improve modeling efficiency, some works explore fully non-autoregressive methods for zero-shot TTS [^08], [^09], [^10].
...
As illustrated in Figure \ref{fig:valle2_abs}, ***VALL-E2*** significantly outperforms VALL-E and other prior works on the LibriSpeech dataset in terms of robustness, naturalness, and similarity score, even achieving human parity performance.
...
Inspired by the success of Large Language Models (LLMs) in natural language processing, **VALL-E**[^05], [^18] represented speech as discrete codec codes with an off-the-shelf neural codec model, and approached TTS as a conditional codec language modeling task.
...
For instance, VALL-E X [^18] extended VALL-E to cross-lingual TTS tasks with an additional language ID token.
...
Mega-TTS [^21] and Mega-TTS 2 [^22] proposed to first disentangle the multiple attributes in speech, then only model partial attributes with a language modeling approach.
...
StyleTTS 2 [^26], UniCATS [^27], NaturalSpeech 2 [^28] and NaturalSpeech 3 [^10] used diffusion model [^29] for the prompt-conditioned text to speech synthesis.
...
AudioPaLM [^35] fused the codec tokens into the LLM PaLM 2 [^36], and demonstrated promising results on speech recognition and translation tasks.
...
This corpus is a labeled version of the Librilight corpus [^47] that contains 50k hours of speech with around 7000 distinct speakers derived from open-source English audiobooks that are part of the LibriVox project\footnote{\url{https://librivox.org}}.
...
Following [^52] and **VALL-E**[^05], we use samples from LibriSpeech test-clean with lengths between 4 and 10 seconds, resulting in a 2.2 hours subset and 40 unique speakers.
...
[^06]: song2024ella
[^07]: xin2024rall
[^08]: borsos2023soundstorm
[^09]: le2024voicebox
[^10]: ju2024naturalspeech
[^11]: kang2024libriheavy
[^12]: panayotov2015librispeech
[^13]: veaux2016superseded
[^14]: DBLP:conf/iclr/ChenASBRZWCTLGO19
[^15]: DBLP:conf/interspeech/WangTFYWZ20
[^16]: DBLP:conf/nips/ArikCPPZ18
[^17]: casanova2022yourtts
[^18]: zhang2023speak
[^19]: kharitonov2023speak
[^20]: huang2023make
[^21]: jiang2023mega
[^22]: jiang2023mega2
[^23]: yang2023uniaudio
[^24]: lajszczak2024base
[^25]: chang2022maskgit
[^26]: li2024styletts
[^27]: du2024unicats
[^28]: shen2023naturalspeech
[^29]: ho2020denoising
[^30]: vyas2023audiobox
[^31]: lipman2022flow
...
[^33]: wang2023speechx
[^34]: wang2023viola
[^35]: rubenstein2023audiopalm
[^36]: anil2023palm
[^37]: zeghidour2021soundstream
[^38]: defossez2022high
[^39]: siuzdak2023vocos
[^40]: zhang2023speechtokenizer
[^41]: wu2023audiodec
[^42]: yang2023hifi
[^43]: kumar2024high
[^44]: du2024funcodec
[^45]: huang2023repcodec
...
[^50]: reddy2021dnsmos
[^51]: itu2018p
[^52]: DBLP:journals/corr/abs-2209-03143
