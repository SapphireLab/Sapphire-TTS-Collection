...
[^22] achieved the lowest frame rate for a NAC model, reaching 12.5Hz by incorporating Transformer models and SpeechTokenizer.
...
Early models relied on speaker embeddings or speaker adaptation[^23], [^24], [^25],
...
Follow-up studies have explored various extensions such as VALL-E~X for cross-lingual TTS[^05], ELLA-V using Montreal forced aligner[^06],
RALL-E using prosody features[^09], VALL-E R using monotonic alignment[^07], VALL-E 2 using grouped code modeling[^08], and MELLE using mel-spectrogram features[^10].
Prosody information can also be modeled by LLMs
latent language mode
Mega-TTS[^27] and Mega-TTS 2[^28] introduced prosody LLMs to generate more natural prosody.
...
As expected, longer audio length {resulted} in better performance. In zero-shot TTS, due to the limited context, the voice-cloning results are typically inferior to standard fine-tuning [^37]. Our proposed method has the potential to push the limits of such zero-shot TTS capabilities.
...
[^01]: brown2020language
[^02]: chowdhery2023palm
[^03]: zeng2023glm130b
[^04]: wang2023valle
[^05]: zhang2023vallex
[^06]: song2024ella
...
[^09]: xin2024ralle
[^10]: meng2024melle
[^11]: zeghidour2021soundstream
[^12]: defossez2022encodec
[^13]: kumar2024DAC
[^14]: Zhang2024SpeechTokenizer
[^15]: wu2023audiodec
[^16]: huang2023repcodec
[^17]: du2024funcodec
[^18]: yang2023hificodec
[^19]: guo2022longt5
[^20]: chen2024longlora
[^21]: han2024hyperattention
[^22]: defossezmoshi
[^23]: casanova22yourtts
[^24]: arik2018neuralvoicecloning
[^25]: chen2019sample
[^26]: xin2024rall
[^27]: jiang2023mega
[^28]: jiang2024megatts2
[^29]: shen2023naturalspeech2
[^30]: ju2024naturalspeech3
[^31]: le2024voicebox
[^32]: guo2023prompttts
[^33]: leng2024prompttts2
[^34]: yang2023uniaudio
[^35]: vyas2023audiobox
[^36]: ITU2018dnsmos
[^37]: anastassiou2024seed
[^38]: borsos2023audiolm
[^39]: zhang2023speechgpt
[^40]: mitsui2024pslm
[^41]: lemerle2024small
[^42]: hsu2021hubert
[^43]: chen2022wavlm
[^44]: lakhotia2021generative
[^45]: chu2023qwen
