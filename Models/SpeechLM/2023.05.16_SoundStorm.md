...
Unsupervised speech embeddings ([Wav2Vec2.0](../Speech_Representaion/2020.06.20_Wav2Vec2.0.md); [HuBERT](../Speech_Representaion/2021.06.14_HuBERT.md); [W2V-BERT](../Speech_Representaion/2021.08.07_W2V-BERT.md)) have provided a low-framerate representation of the underlying signal which remains rich enough after discretization for language models to generate intelligible speech from a specific speaker as a sequence of tokens ([Generative Spoken Language Modeling (2021)]()).
