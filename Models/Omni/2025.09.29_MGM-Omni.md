...
- 链接:
  ...
  - [Demo]()
- 文件:
  - [ArXiv:2509.25131v1](PDF/2025.09.29_2509.25131v1__MGM-Omni__Scaling_Omni_LLMs_to_Personalized_Long-Horizon_Speech.pdf)
  - [Publication] #TODO
...
Most existing approaches are vision-centric, treating audio as a secondary input modality and relying on separate, cascaded text-to-speech (TTS) systems for generation[^Oord2016WaveNet], [^Anastassiou2024Seed-TTS], [^Du2024CosyVoice].
...
|---|:-:|:-:|:-:|:-:|:-:|:-:|
|CosyVoice2[^Du2024CosyVoice]||||√||√|
|Higgs-Audio-v2[^BosonAI2025HiggsAudioV2]||||√|√|√|
|Qwen2.5-VL[^Bai2025Qwen2.5-Vl]|√||||||
|Qwen2.5-Omni[^Xu2025Qwen2.]|√|√||√|||
|Lyra[^Zhong2024Lyra]|√|√|√|√|||
|***MGM-Omni***|√|√|√|√|√|√|

> Tab.01: **Function comparison.**
...
Audio token sequences are significantly more extensive and operate at a finer temporal resolution compared to their corresponding text token sequences (**WaveNet**[^Oord2016WaveNet], **Tacotron2**[^Shen2017Tacotron2]).
...
Despite recent progress ([^Huang2025Step-Audio], [^Xu2025Qwen2.], [^Team2025Text], [^BosonAI2025HiggsAudioV2]), these systems do not address the intertwined issues of long-form audio understanding, alignment, and generation.
...
In recent years, driven by the emergence of large language models (LLMs) and large-scale speech-text pre-training, zero-shot text-to-speech generation (TTS) has advanced markedly[^Anastassiou2024Seed-TTS], [^Du2024CosyVoice], [^BosonAI2025HiggsAudioV2].
...
These speech tokens are further converted into Mel-spectrograms through a flow-matching model [^flow-matching], and the final audio is synthesized using a vocoder.
...
The primary encoder, Qwen2-Audio[^Chu2024Qwen2-Audio], is an audio encoder continually trained on Whisper-large-v3[^Radford2022Whisper] for enhanced general sound perception.
...
>
> <a id="speechlm"></a>
> Fig.02: The overview of SpeechLM in ***MGM-Omni***.
> Conditioned on MLLM-generated text and the reference audio clip, SpeechLM generate speech with Chunk-based Parallel Decoding.
...
> <a id="chunking"></a>
> Fig.04: Decoding comparison.
> Chunk-based decoding narrows the gap between text and corresponding speech, enabling long-form speech generation.
...
We compare ***MGM-Omni*** against two categories of open-source TTS systems: (1) Native long TTS models, represented by MOSS-TTSD-v0.5[^Team2025Text] and Higgs-Audio-v2[^BosonAI2025HiggsAudioV2]. (2) Non-native models that extend via chunking, represented by CosyVoice2[^Du2024CosyVoice].
...
We use Whisper-large-v3[^Radford2022Whisper] and Paraformer-zh[^Gao2023Funasr] as the automatic speech recognition (ASR) engines for English and Chinese, respectively.
...
We compare ***MGM-Omni*** with concurrent long TTS systems, MOSS-TTSD-v0.5[^Team2025Text] and Higgs-Audio-v2[^BosonAI2025HiggsAudioV2] to evaluate the long-form speech generation capability.
...
[^OpenAI2023ChatGPT]: ChatGPT.
[^Touvron2023LLaMA]: LLaMA: Open and Efficient Foundation Language Models. arXiv:2302.13971.
[^Liu2023Visual]: Visual Instruction Tuning. Advances in Neural Information Processing Systems 2023.
[^OpenAI2023GPT-4]: GPT-4 Technical Report. arXiv:2303.08774.
[^Team2023Gemini]: Gemini: A Family of Highly Capable Multimodal Models. arXiv:2312.11805.
...
[^BosonAI2025HiggsAudioV2]: [**HiggsAudioV2**: Redefining Expressiveness in Audio Generation](../SpeechLM_TTS/2025.07.20_HiggsAudioV2.md). .
[^flow-matching]: ?
[^Bai2025Qwen2.5-Vl]: Qwen2.5-Vl Technical Report. arXiv:2502.13923.
[^Xu2025Qwen2.]: Qwen2. 5-Omni Technical Report. arXiv:2503.20215.
...
[^Li2024Llama-Vid]: Llama-Vid: An Image Is Worth 2 Tokens in Large Language Models. European Conference on Computer Vision 2024.
[^Li2024Mini-Gemini]: Mini-Gemini: Mining the Potential of Multi-Modality Vision Language Models. arXiv:2403.18814.
[^Liu2025Seg-Zero]: Seg-Zero: Reasoning-Chain Guided Segmentation via Cognitive Reinforcement. arXiv:2503.06520.
...
[^Zhu2023Minigpt-4]: Minigpt-4: Enhancing Vision-Language Understanding With Advanced Large Language Models. arXiv:2304.10592.
[^Liu2023Improved]: Improved Baselines With Visual Instruction Tuning. arXiv:2310.03744.
[^Li2024Llava-Onevision]: Llava-Onevision: Easy Visual Task Transfer. arXiv:2408.03326.
[^Wang2024Qwen2-Vl]: Qwen2-Vl: Enhancing Vision-Language Model's Perception of the World at Any Resolution. arXiv:2409.12191.
[^Fu2024VITA]: Vita: Towards Open-Source Interactive Omni Multimodal LLM. arXiv:2408.05211.
[^Dehghani2023Patch]: Patch N’pack: Navit, a Vision Transformer for Any Aspect Ratio and Resolution. Advances in Neural Information Processing Systems 2023.
[^Chu2024Qwen2-Audio]: Qwen2-Audio Technical Report. arXiv:2407.10759.
...
[^BELLEGroup2023Belle]: BELLE: Be Everyone's Large Language Model Engine. GitHub Repository 2023.
...
[^Bu2017Aishell-1]: Aishell-1: An Open-Source Mandarin Speech Corpus and a Speech Recognition Baseline. 2017 20th Conference of the Oriental Chapter of the International Coordinating Committee on Speech Databases and Speech I/O Systems and Assessment (O-Cocosda) 2017.
[^Du2018Aishell-2]: Aishell-2: Transforming Mandarin Asr Research Into Industrial Scale. arXiv:1808.10583.
...
[^Wu2023LaMini-LM]: LaMini-LM: A Diverse Herd of Distilled Models From Large-Scale Instructions. CoRR 2023.
[^Yang2025Qwen2.5]: Qwen2.5 Technical Report. arXiv:2502.13923.
[^Jiang2025Sparse]: Sparse Alignment Enhanced Latent Diffusion Transformer for Zero-Shot Speech Synthesis. arXiv:2502.18924.
...
[^Yang2024Air-Bench]: Air-Bench: Benchmarking Large Audio-Language Models via Generative Comprehension. arXiv:2402.07729.
[^Liu2024Deepseek-V3]: Deepseek-V3 Technical Report. arXiv:2412.19437.
[^Muennighoff2025S1]: S1: Simple Test-Time Scaling. arXiv:2501.19393.
[^Comanici2025Gemini]: Gemini 2.5: Pushing the Frontier With Advanced Reasoning, Multimodality, Long Context, and Next Generation Agentic Capabilities. arXiv:2507.06261.
[^Gao2023Funasr]: Funasr: A Fundamental End-to-End Speech Recognition Toolkit. arXiv:2305.11013.
[^OpenAI2025GPT-5]: GPT-5 System Card.