---
PDF: <a href="2210.13438v1__Encodec__High_Fidelity_Neural_Audio_Compression.pdf"></a>
...
| 机构  | MetaAI, FAIR Team                                                                                                                                                                        |
| 时间  | 2022.10.24 (v1)                                                                                                                                                                          |
| 链接  | [>ArXiv<](https://arxiv.org/abs/2210.13438) >DOI< [>Github<](https://github.com/facebookresearch/encodec)                                                                                |
| 标签  |                                                                                                                                                                                          |
|     |                                                                                                                                                                                          |
...
> Similarly, Lakhotia et al. (2021); Kharitonov et al. (2021) demonstrated that self-supervised learning methods for speech (e.g., HuBERT (Hsu et al., 2021)), can be quantized and used for conditional and unconditional speech generation.
...
遵循 Zeghidour 等人的设置, 我们使用 $C=32$, $B=4$, $(2, 4, 5, 8)$ 作为步长.
