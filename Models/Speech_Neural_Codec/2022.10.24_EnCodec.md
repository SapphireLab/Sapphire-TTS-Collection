...
![](../_Images/2022.10.24_Encodec_Fig.01.png)
...
> For the frequency domain, we use a linear combination between the L1 and L2 losses over the mel-spectrogram using several time scales ([Parallel WaveGAN (2019)](../TTS3_Vocoder/2019.10_Parallel_WaveGAN.md); Gritsenko et al., 2020).
