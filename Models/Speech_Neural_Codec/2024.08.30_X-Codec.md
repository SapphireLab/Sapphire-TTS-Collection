...
- 作者:
  | 序号 | 作者 | 机构 |
  | :-: | :-: | :-: |
  | 01 | [Zhen Ye](../../Authors/Zhen_Ye.md) | [香港科技大学](../../Institutions/CHN-HKUST_香港科技大学.md) |
  | 02 | [Peiwen Sun](../../Authors/Peiwen_Sun.md) | [香港科技大学](../../Institutions/CHN-HKUST_香港科技大学.md) |
  | 03 | [Jiahe Lei](../../Authors/Jiahe_Lei.md) | [北京科技大学](../../Institutions/CHN-USTB_北京科技大学.md) |
  | 04 | [Hongzhan Lin](../../Authors/Hongzhan_Lin.md) | [香港浸会大学](../../Institutions/CHN-HKBU_香港浸会大学.md) |
  | 05 | [Xu Tan](../../Authors/Xu_Tan_(谭旭).md) | [Microsoft](../../Institutions/USA-Microsoft.md) |
  | 06 | [Zheqi Dai](../../Authors/Zheqi_Dai.md) | [香港中文大学](../../Institutions/CHN-CUHK_香港中文大学.md) |
  | 07 | [Qiuqiang Kong](../../Authors/Qiuqiang_Kong.md) | [香港中文大学](../../Institutions/CHN-CUHK_香港中文大学.md) |
  | 08 | [Jianyi Chen](../../Authors/Jianyi_Chen.md) | [香港科技大学](../../Institutions/CHN-HKUST_香港科技大学.md) |
  | 09 | [Jiahao Pan](../../Authors/Jiahao_Pan.md) | [香港科技大学](../../Institutions/CHN-HKUST_香港科技大学.md) |
  | 10 | [Qifeng Liu](../../Authors/Qifeng_Liu_(柳崎峰).md) | [香港科技大学](../../Institutions/CHN-HKUST_香港科技大学.md) |
  | 11 | [Yike Guo](../../Authors/Yike_Guo_(郭毅可).md) | [香港科技大学](../../Institutions/CHN-HKUST_香港科技大学.md) |
  | 12 | [Wei Xue](../../Authors/Wei_Xue_(雪巍).md) | [香港科技大学](../../Institutions/CHN-HKUST_香港科技大学.md) |
- 机构:
  | 序号 | 机构名称 | 占比 |
  | :-: | :-: | :-: |
  | 01 | [香港科技大学](../../Institutions/CHN-HKUST_香港科技大学.md) | 7/12 |
  | 02 | [Microsoft](../../Institutions/USA-Microsoft.md) | 1/12 |
  | 03 | [北京科技大学](../../Institutions/CHN-USTB_北京科技大学.md) | 1/12 |
  | 04 | [香港浸会大学](../../Institutions/CHN-HKBU_香港浸会大学.md) | 1/12 |
  | 05 | [香港中文大学](../../Institutions/CHN-CUHK_香港中文大学.md) | 2/12 |
- 时间:
...
> The existing research on audio LLM has primarily focused on enhancing the architecture and scale of audio language models, as well as leveraging larger datasets, and generally, acoustic codecs, such as [EnCodec](2022.10.24_EnCodec.md), are used for audio tokenization. 
...
> For instance, existing methods like [VALL-E](../Speech_LLM/2023.01.05_VALL-E.md), which condition acoustic token generation on text transcriptions, often suffer from content inaccuracies and elevated word error rates (WER) due to semantic misinterpretations of acoustic tokens, resulting in word skipping and errors. 
...
> As a result, LLM essentially tries to predict the local fluctuations of the audio signal, which is difficult, and methods like [VALL-E](../Speech_LLM/2023.01.05_VALL-E.md), which condition acoustic token generation on text transcriptions, frequently result in content inaccuracies causing elevated word error rates (WER), stemming from the semantic misinterpretations of acoustic tokens, leading to word skipping and errors.
>
...
> Furthermore, our comparative evaluation on [VALL-E](../Speech_LLM/2023.01.05_VALL-E.md) based TTS demonstrates that ***X-Codec*** outperforms existing disentanglement techniques, thereby highlighting its efficacy and versatility in advancing audio LLM technologies.
...
> For example, [SpeechTokenizer](2023.08.31_SpeechTokenizer.md) utilizes [HuBERT](../Speech_Representaion/2021.06.14_HuBERT.md) to separate speech into distinct VQ components for content and timbre/acoustic details. 
> This separation improves the modeling of content in the AR stage of [VALL-E](../Speech_LLM/2023.01.05_VALL-E.md), while the NAR stage enriches the acoustic details. 
...
> Another attempt is presented by [SemantiCodec](2024.04.30_SemantiCodec.md), which employs a pre-trained [AudioMAE](../_tmp/AudioMAE.md) to generate distinct semantic and acoustic tokens from mel-spectrograms. 
...
> As illustrated in Figure.01, our model builds upon the framework established by existing acoustic codecs such as [EnCodec](2022.10.24_EnCodec.md) and [DAC](2023.06.11_Descript-Audio-Codec.md). 
...
> In this section, we investigate the impact of acoustic codecs on the performance of audio LLMs, focusing specifically on [VALL-E](../Speech_LLM/2023.01.05_VALL-E.md), a pioneering model that leverages language model principles for text-to-speech. 
> Our analysis reveals that training [VALL-E](../Speech_LLM/2023.01.05_VALL-E.md) using [EnCodec](2022.10.24_EnCodec.md) results in high word error rates (WER) and frequent inaccuracies in content generation. 
...
> This misinterpretation, which is beyond simply improving the audio quality, suggests a fundamental limitation in [EnCodec](2022.10.24_EnCodec.md)'s ability to differentiate phonemes, possibly due to its inadequate semantic processing capabilities.
>
> To substantiate the above hypothesis, we conducted Phonetic Discriminability ABX Tests to evaluate the phonetic discriminability of [EnCodec](2022.10.24_EnCodec.md)'s representations. 
> The details are provided in the experiment section. 
> Our findings reveal that [EnCodec](2022.10.24_EnCodec.md)'s representations exhibit poor phonetic discriminability, which confirms the presence of semantic inadequacies in the codec. 
...
> Given that established audio codecs such as [EnCodec](2022.10.24_EnCodec.md), [SpeechTokenizer](2023.08.31_SpeechTokenizer.md), and [DAC](2023.06.11_Descript-Audio-Codec.md) are trained on diverse datasets with varying configurations, we meticulously design experiments to rigorously evaluate the efficacy of our proposed solution, ***X-Codec***. 
...
> In this subsection, we critically evaluate the performance of various audio codecs in training the [VALL-E](../Speech_LLM/2023.01.05_VALL-E.md) model for zero-shot Text-to-Speech (TTS) tasks. 
...
> - To evaluate the comparative advantages of ***X-Codec*** over the disentanglement strategy employed by [SpeechTokenizer](2023.08.31_SpeechTokenizer.md), specifically within the context of the [VALL-E](../Speech_LLM/2023.01.05_VALL-E.md) model.

#### Baselines

> For a comprehensive comparison, we employ several state-of-the-art neural audio codecs as baselines:
> - [EnCodec](2022.10.24_EnCodec.md) ([HuggingFace](https://huggingface.co/facebook/encodec_24khz)): The open-source [EnCodec](2022.10.24_EnCodec.md) model, trained on a diverse range of 24kHz audio data, can compress audio to bitrates between 1.5 and 24.0 kbps while maintaining high fidelity.
...
> For reproduction of the [VALL-E](../Speech_LLM/2023.01.05_VALL-E.md), we utilize the resources specified in the provided repository ([Github](https://github.com/lifeiteng/vall-e)). 
...
> - [WER (Word Error Rate)](../../Evaluations/WER.md): We utilize an Automatic Speech Recognition (ASR) model to transcribe the generated audio ([VALL-E](../Speech_LLM/2023.01.05_VALL-E.md)). 
...
> Sim-O uses feature embeddings extracted from a pre-trained speaker verification model to measure this similarity ([HuBERT](../Speech_Representaion/2021.06.14_HuBERT.md); [CLaM-TTS](../Speech_LLM/2024.04.03_CLaM-TTS.md)) ([Github](https://github.com/microsoft/UniSpeech/tree/main/downstreams/speaker_verification)), reflecting the codec's ability to preserve speaker characteristics.
> - [UTMOS](../../Evaluations/UTMOS.md): We evaluate the audio quality using UTMOS, a Speech MOS (Mean Opinion Score) predictor ([Github](https://github.com/tarepan/SpeechMOS)) that automatically measures the naturalness of speech. 
> This metric provides insights into the overall auditory quality of the synthesized speech.

#### Zero-shot TTS Results

> We use [librispeech-test-clean](../../Datasets/2015.04.19_LibriSpeech.md) for zero-shot TTS evaluation following [VALL-E](../Speech_LLM/2023.01.05_VALL-E.md)-continual-setting. 
> The results in Table \ref{valle_exp} demonstrate the following key findings:

> - When comparing both ***X-Codec*** and [SpeechTokenizer](2023.08.31_SpeechTokenizer.md) against the baseline and other acoustic codecs like [DAC](2023.06.11_Descript-Audio-Codec.md) and [EnCodec](2022.10.24_EnCodec.md), we observe improvements in WER. 
...
> - Both [SpeechTokenizer](2023.08.31_SpeechTokenizer.md) and ***X-Codec*** significantly outperform pure acoustic codecs like [EnCodec](2022.10.24_EnCodec.md) and [DAC](2023.06.11_Descript-Audio-Codec.md) in phonetic discriminability, which supports our claim that enhancing semantic understanding in codecs helps modelling content such as phonetic details.
...
> Conventional methods for general audio representation learning, aiming at capturing the semantic discriminability of audios, are generally based on 2D mel-spectrogram, such as [AudioMAE](../_tmp/AudioMAE.md) and [Beats](../_tmp/Beats.md). 
...
>
> To bridge this gap, we have developed a variant of [HuBERT](../Speech_Representaion/2021.06.14_HuBERT.md), specifically adapted for general audio, which we refer to as **HuBERT-General-Audio**. 
...
> For training stability, we adopt an inverse square root learning schedule, a modification from the polynomial decay schedule originally utilized in [HuBERT](../Speech_Representaion/2021.06.14_HuBERT.md). 
> The learning rate is set at 0.0003 with warmup steps of 32,000. 
> Unlike the original [HuBERT](../Speech_Representaion/2021.06.14_HuBERT.md), which utilizes MFCCs as the training target unit designed specifically for speech, our model leverages the first VQ layer of [EnCodec](2022.10.24_EnCodec.md) as the training target for acoustic unit discovery in the general audio. 
...
>
> Our findings indicate that **HuBERT-General-Audio** significantly outperforms traditional acoustic codecs such as [DAC](2023.06.11_Descript-Audio-Codec.md), [EnCodec](2022.10.24_EnCodec.md), and the baseline acoustic codec across all metrics. 
