...
Unlike the original [HuBERT](../SpeechRepresentation/2021.06.14_HuBERT.md), which utilizes MFCCs as the training target unit designed specifically for speech, our model leverages the first VQ layer of [EnCodec](2022.10.24_EnCodec.md) as the training target for acoustic unit discovery in the general audio.
