...
> Modeling discrete representations of audio produced by neural codecs ([SoundStream (2021)](2021.07_SoundStream.md); [EnCodec (2022)]()) makes the task of audio generation amenable to the powerful Transformer-based sequence-to-sequence modeling approaches ([Transformer (2017)](2017.06_Transformer.md)).
> Casting unconditional and conditional audio generation as sequence-to-sequence modeling has unlocked rapid progress in speech continuation ([AudioLM (2022)](2022.09_AudioLM.md)), text-to-speech ([VALL-E (2023)](../LLM/2023.01_VALL-E.md); [SPEAR-TTS (2023)](2023.02_SPEAR-TTS.md)), and general audio and music generation ([AudioGen (2022)](); [MusicLM (2023)]()).
...
> 3. Custom architectures adapted to the special structure of the tokens produced by neural audio codecs ([AudioGen (2022)](); [VALL-E (2023)](../LLM/2023.01_VALL-E.md); [RQ-Transformer (2022)]()).
>
...
> We demonstrate that SoundStorm can serve as [AudioLM (2022)](2022.09_AudioLM.md)’s acoustic generator, replacing both [AudioLM (2022)](2022.09_AudioLM.md)’s stage two(coarse acoustic model) and stage three (fine acoustic model).
...
> [VALL-E (2023)](../LLM/2023.01_VALL-E.md) instead relies on a hybrid approach, where the tokens corresponding to the first RVQ level are predicted autoregressively, and the subsequent levels are produced non-autoregressively.
