...
- [VoiceBox](../../Models/_tmp/2023.06.23_VoiceBox.md) 和 [P-Flow](../../Models/_tmp/P-Flow.md) 采用流模型作为生成器, 展示出健壮的生成性能.
...
> As illustrated in Fig.02, ***ControlSpeech*** is fundamentally an encoder-decoder model based on [FastSpeech2](../../Models/TTS2_Acoustic/2020.06.08_FastSpeech2.md) for codec generation.
...
> Follow [VALL-E](../../Models/Speech_LLM/2023.01.05_VALL-E.md), in the training process of ***ControlSpeech***, we randomly select a certain channel of $C_{1:T,1:N}$ for training.
...
> In the second stage, following [AdaSpeech](../../Models/_tmp/2021.03.01_AdaSpeech.md), we utilize a conditional normalization layer to fuse the previously obtained $Y_{codec} and $Y_t$, producing the input for the codec decoder.
...
第二个阶段, 遵循 [AdaSpeech](../../Models/_tmp/2021.03.01_AdaSpeech.md), 我们利用条件归一化层融合之前获得的 $Y_{codec}$ 和 $Y_t$, 产生编解码器解码器的输入.
