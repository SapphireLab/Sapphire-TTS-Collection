...
[^Wang2025Spark-Tts]: Spark-Tts: An Efficient LLM-Based Text-to-Speech Model With Single-Stream Decoupled Speech Tokens. 
...
[^Huynh-Nguyen2025OZSpeech]: OZSpeech: One-Step Zero-Shot Speech Synthesis With Learned-Prior-Conditioned Flow Matching. 
...
[^Yang2025Shallow]: Shallow Flow Matching for Coarse-to-Fine Text-to-Speech Synthesis. 
[^Park2025RapFlow-TTS]: RapFlow-TTS: Rapid and High-Fidelity Text-to-Speech With Improved Consistency Flow Matching. 
[^Zhu2025ZipVoice]: ZipVoice: Fast and High-Quality Zero-Shot Text-to-Speech With Flow Matching. 
[^Ren2019FastSpeech]: FastSpeech: Fast, Robust and Controllable Text to Speech. Proceedings of the 33rd International Conference on Neural Information Processing Systems 2019.
[^Kim2021Conditional]: Conditional Variational Autoencoder With Adversarial Learning for End-to-End Text-to-Speech. 
[^Kong2023Vits2]: VITS2: Improving Quality and Efficiency of Single-Stage Text-to-Speech With Adversarial Learning and Architecture Design. 
[^Mehta2024Should]: Should You Use a Probabilistic Duration Model in TTS? Probably! Especially for Spontaneous Speech. 
[^Peebles2023Scalable]: Scalable Diffusion Models With Transformers. 
...
[^Lemerle2024Small-E]: Small-E: Small Language Model With Linear Attention for Efficient Speech Synthesis. 
[^Peng2023Rwkv]: RWKV: Reinventing RNNs for the Transformer Era. 
[^Gu2024Mamba]: Mamba: Linear-Time Sequence Modeling With Selective State Spaces. 
[^Yang2024Gated]: Gated Linear Attention Transformers With Hardware-Efficient Training. 
...
[^Yao2024Zipformer]: Zipformer: A Faster and Better Encoder for Automatic Speech Recognition. 
[^Li2024Cm-Tts]: CM-TTS: Enhancing Real Time Text-to-Speech Synthesis Efficiency Through Weighted Samplers and Consistency Models. 
[^Ye2023CoMoSpeech]: CoMoSpeech: One-Step Speech and Singing Voice Synthesis via Consistency Model. 
[^Meng2024Autoregressive]: Autoregressive Speech Synthesis Without Vector Quantization. CoRR 2024.
[^Liu2024Autoregressive]: Autoregressive Diffusion Transformer for Text-to-Speech Synthesis. 
