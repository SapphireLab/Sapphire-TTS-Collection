...
- 链接:
  - [ArXiv](https://arxiv.org/abs/2309.03199) v2
...
- 文件:
  - [ArXiv](../Diffusion/_PDF/2309.03199v2__Matcha-TTS__A_Fast_TTS_Architecture_with_Conditional_Flow_Matching.pdf)
  - [Publication](../Diffusion/_PDF/2309.03199p0__Matcha-TTS__ICASSP2024.pdf)
...
Although these models, and descendants like [Fast Grad-TTS](../Acoustic/2022.09.18_Fast_Grad-TTS.md), are non-autoregressive, [TorToiSe-TTS](../Diffusion/2023.05.12_TorToise-TTS.md) demonstrated DPMs in an autoregressive TTS model with quantised latents.
...
***Matcha-TTS*** also uses Transformers in the decoder, but in a 1D U-Net design inspired by the 2D U-Nets in the Stable Diffusion image-generation model ([LDM](../Diffusion/_2021.12.20_LDM.md)).
...
CFM is a new technique that differs from earlier approaches to speed up SDE/ODE-based TTS, which most often were based on distillation (e.g., [ProDiff](../Diffusion/2022.07.13_ProDiff.md); [Fast Grad-TTS](../Acoustic/2022.09.18_Fast_Grad-TTS.md); [CoMoSpeech](../Diffusion/2023.05.11_CoMoSpeech.md)).
...
Inspired by [LDM](../Diffusion/_2021.12.20_LDM.md), it is a U-Net containing 1D convolutional residual blocks to downsample and upsample the inputs, with the flow-matching step $t\in[0,1]$ embedded as in [Grad-TTS](../Acoustic/2021.05.13_Grad-TTS.md).
