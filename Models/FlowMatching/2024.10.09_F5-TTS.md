...
Recent research in Text-to-Speech (TTS) has experienced great advancement ([Tacotron2](../Acoustic/2017.12.16_Tacotron2.md)[^01]; [Transformer-TTS](../Acoustic/2018.09.19_TransformerTTS.md)[^02]; [FastSpeech 2](../Acoustic/2020.06.08_FastSpeech2.md)[^03]; [Glow-TTS](../Acoustic/2020.05.22_Glow-TTS.md)[^04]; [VITS](../E2E/2021.06.11_VITS.md)[^05]; [Grad-TTS](../Acoustic/2021.05.13_Grad-TTS.md)[^06]; [VioLA](../SpeechLM/ST2ST/2023.05.25_VioLA.md)[^07]; [NaturalSpeech](../E2E/2022.05.09_NaturalSpeech.md)[^08]).
With a few seconds of audio prompt, current TTS models are able to synthesize speech for any given text and mimic the speaker of audio prompt ([VALL-E [9]](../SpeechLM/ST2S/2023.01.05_VALL-E.md); [VALL-E X [10]](../SpeechLM/ST2S/2023.03.07_VALL-E_X.md)).
The synthesized speech can achieve high fidelity and naturalness that they are almost indistinguishable from human speech ([NaturalSpeech 2 [11]](2023.04.18_NaturalSpeech2.md); [NaturalSpeech 3 [12]](2024.03.05_NaturalSpeech3.md); [VALL-E 2 [13]](../SpeechLM/ST2S/2024.06.08_VALL-E_2.md); [Voicebox [14]](../SpeechLM/2023.06.23_VoiceBox.md)).

[^01]: [**Tacotron2**: Natural TTS Synthesis by Conditioning WaveNet on Mel Spectrogram Predictions.](../Acoustic/2017.12.16_Tacotron2.md) ICASSP 2017.
[^02]: [**Transformer-TTS**: Neural Speech Synthesis with Transformer Network.](../Acoustic/2018.09.19_TransformerTTS.md) AAAI 2019.
[^03]: [**FastSpeech2**: Fast and High-Quality End-to-End Text to Speech.](../Acoustic/2020.06.08_FastSpeech2.md) ArXiv 2020.
[^04]: [**Glow-TTS**: A Generative Flow for Text-to-Speech via Monotonic Alignment Search.](../Acoustic/2020.05.22_Glow-TTS.md) NeurIPS 2020.
[^05]:
[^06]:
[^07]:
[^08]:
...
While autoregressive (AR) based TTS models exhibit an intuitive way of consecutively predicting the next token(s) and have achieved promising zero-shot TTS capability, the inherent limitations of AR modeling require extra efforts addressing issues such as inference latency and exposure bias ([ELLA-V [15]](../SpeechLM/ST2S/2024.01.14_ELLA-V.md); [VALL-T [16]](../SpeechLM/ST2S/2024.01.25_VALL-T.md); [VALL-E R [17]](../SpeechLM/ST2S/2024.06.12_VALL-E_R.md); [RALL-E [18]](../SpeechLM/ST2S/2024.04.04_RALL-E.md); [VoiceCraft [19]](../SpeechLM/2024.03.25_VoiceCraft.md)).
Moreover, the quality of speech tokenizer is essential for AR models to achieve high-fidelity synthesis ([SoundStream [20]](../Tokenizer/2021.07.07_SoundStream.md); [EnCodec [21]](../Tokenizer/2022.10.24_EnCodec.md); [AudioDec [22]](../Tokenizer/2023.05.26_AudioDec.md); [HiFi-Codec [23]](../Tokenizer/2023.05.04_HiFi-Codec.md); [SpeechTokenizer [24]](../SpeechCodec/2023.08.31_SpeechTokenizer.md); [dMel [25]](../SpeechCodec/2024.07.22_dMel.md); [NDVQ [26]](../SpeechCodec/2024.09.19_NDVQ.md)).
Thus, there have been studies exploring direct modeling in continuous space ([ARDiT [27]](2024.06.08_ARDiT.md); [MAR [28]](../CV/2024.06.17_MAR.md); [MELLE [29]](../SpeechLM/ST2S/2024.07.11_MELLE.md)) to enhance synthesized speech quality recently.
...
Notably, diffusion models ([DDPM [30]](_2020.06.19_DDPM.md); [Song et al.(2020) [31]](_2020.11.26_Score-Based_Generative_Modeling_through_SDE.md)) contribute most to the success of current NAR speech models ([NaturalSpeech 2 [11]](2023.04.18_NaturalSpeech2.md); [NaturalSpeech 3 [12]](2024.03.05_NaturalSpeech3.md)).
In particular, [Flow Matching with Optimal Transport path (FM-OT) [32]](../FlowMatching/_2022.10.06_Flow_Matching.md) is widely used in recent research fields not only text-to-speech ([Voicebox [14]](../SpeechLM/2023.06.23_VoiceBox.md); [VoiceFlow [33]](../FlowMatching/2023.09.10_VoiceFlow.md); [Matcha-TTS [34]](2023.09.06_Matcha-TTS.md); [DiTTo-TTS [35]](2024.06.17_DiTTo-TTS.md); [**E2 TTS** [36]](2024.06.26_E2_TTS.md)) but also image generation ([StableDiffusion3 [37]](2024.03.05_StableDiffusion3.md)) and music generation ([FluxMusic [38]](2024.09.01_FluxMusic.md)).
...
[DiTTo-TTS [35]](2024.06.17_DiTTo-TTS.md) uses [Diffusion Transformer (DiT) [41]](_2022.12.19_DiT.md) with cross-attention conditioned on encoded text from a pretrained language model.
...
In contrast, [**E2 TTS**](../Diffusion/2024.06.26_E2_TTS.md)[^36], based on [Voicebox [14]](../SpeechLM/2023.06.23_VoiceBox.md), adopts a simpler way, which removes the phoneme and duration predictor and directly uses characters padded with filler tokens to the length of mel spectrograms as input.
...
As we have no prior knowledge of how to approximate $p_t$ and $u_t$, a conditional probability path $p_t(x|x_1) = \mathcal{N}(x\ |\ \mu_t(x_1),\sigma_t(x_1)^2I)$ is considered in actual training, and the Conditional Flow Matching (CFM) loss is proved to have identical gradients w.r.t. $\theta$ ([Flow Matching [32]](../FlowMatching/_2022.10.06_Flow_Matching.md)).
...
To view in a more general way ([VDM++ [43]](2023.09.25_VDM++.md)), if formulating the loss in terms of log signal-to-noise ratio (log-SNR) $\lambda$ instead of flow step $t$, and parameterizing to predict $x_0$ ($\epsilon$, commonly stated in diffusion model) instead of predict $x_1-x_0$, the CFM loss is equivalent to the $v$-prediction ([Salimans et al. (2022) [44]](_2022.02.01_Progressive_Distillation.md)) loss with cosine schedule.
...
[Classifier-Free Guidance (CFG) [47]](_2022.07.26_Classifier-Free_Guidance.md) proposes to replace the explicit classifier with an implicit classifier without directly computing the explicit classifier and its gradient.
...
As shown in Fig.01, we use latent [Diffusion Transformer (DiT) [41]](_2022.12.19_DiT.md) as backbone.
...
- autoregressive models: [VALL-E 2 [13]](../SpeechLM/ST2S/2024.06.08_VALL-E_2.md), [MELLE [29]](../SpeechLM/ST2S/2024.07.11_MELLE.md), [FireRedTTS [64]](../SpeechLM/2024.09.05_FireRedTTS.md) and [CosyVoice [65]](../SpeechLM/ST2S/2024.07.07_CosyVoice.md);
- non-autoregressive models: [Voicebox [14]](../SpeechLM/2023.06.23_VoiceBox.md), [NaturalSpeech 3 [12]](2024.03.05_NaturalSpeech3.md), [DiTTo-TTS [35]](2024.06.17_DiTTo-TTS.md), [MaskGCT [66]](../SpeechLM/ST2S/2024.09.01_MaskGCT.md), [Seed-TTS$_{DiT}$ [39]](../SpeechLM/2024.06.04_Seed-TTS.md) and our reproduced [**E2 TTS** [36]](2024.06.26_E2_TTS.md).
...
For WER, we employ **Whisper-Large-V3** [67] to transcribe English and [Paraformer-zh [68]](../ASR/2022.06.16_Paraformer.md) for Chinese, following [Seed-TTS [39]](../SpeechLM/2024.06.04_Seed-TTS.md).
...
A robustness test on [ELLA-V [15]](../SpeechLM/ST2S/2024.01.14_ELLA-V.md) hard sentences is further included in Appendix \ref{appx:ellavhardtest}.
