...
- 文件:
  - [ArXiv](PDF/2025.06.20_2506.16741v1__RapFlow-TTS__Rapid_and_High-Fidelity_Text-to-Speech_with_Improved_Consistency_Flow_Matching.pdf)
...
For intelligibility, we measured word error rate (WER) by applying the **Whisper**[^Radford2022Whisper]-M-based ASR model to the synthesized speech.
...
[^Liu2022RectifiedFlow]: [**RectifiedFlow**: Flow Straight and Fast: Learning to Generate and Transfer Data with Rectified Flow](_2022.09.07_RectifiedFlow.md). ArXiv:2209.03003v1.
[^Song2023ConsistencyModel]: [Consistency Model](../Consistency/_2023.03.02_CM.md
...
[^Yang2024ConsistencyFM]: [Consistency Flow Matching](_2024.07.02_Consistency_Flow_Matching.md)
[^Yang2024ConsistencyFM]: [Consistency Flow Matching](_2024.07.02_Consistency_Flow_Matching.md)
[^Song2023iCT]: [iCT](../Consistency/2023.10.22_iCT.md)
[^Kim2025SimpleReFlow]: [Simple ReFlow](_2024.10.10_SimpleReFlow.md)
[^Lee2024ReFlow++]: [ReFlow++](_2024.05.30_ReFlow++.md)
[^Kim2025SimpleReFlow]: [Simple ReFlow](_2024.10.10_SimpleReFlow.md)
[^Lee2024ReFlow++]: [ReFlow++](_2024.05.30_ReFlow++.md)
