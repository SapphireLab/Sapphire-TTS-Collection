...
% 
> <a id="fig:x0-vitual">![](figs/x0-virtual.pdf)</a>
...
These units have a value range spanning from 0 to 1023.\\[8pt]
**Evaluation dataset**.

We follow the VALL-E evaluation protocol [^Chen2025Neural].
...
-  **SIM-O** and **SIM-R** are metrics used to evaluate speaker similarity. **SIM-O** measures the similarity between the synthesized speech and the original prompt, while **SIM-R** evaluates the similarity between the synthesized speech and the reconstructed prompt generated by FACodec [^Ju2024N}atural{S}peech].
...
% 
-  **PESQ** [^Rix2001Perceptual] (Perceptual Evaluation of Speech Quality) is used to evaluate the perceptual quality.
...
-  **VoiceCraft** [^Peng2024V}oice{C}raft].
...
-  **NaturalSpeech 2** [^Shen2024NaturalSpeech].

We use the Amphion toolkit [^Zhang2024Amphion] and pre-trained checkpoint \footnote{\url{https://huggingface.co/amphion/naturalspeech2_libritts/tree/main/checkpoint}}, which is trained on the LibriTTS dataset [^Zen2019LibriTTS].

-  **F5-TTS** [^Chen2024F5-TTS].

We use the official code and pre-trained checkpoint \footnote{\url{https://huggingface.co/SWivid/F5-TTS/blob/main/F5TTS_Base_bigvgan/model_1250000.pt}}, which is trained on the Emilia dataset [^He2024Emilia].

-  **VALL-E** [^Chen2025Neural].

We reproduce VALL-E using the Amphion toolkit [^Zhang2024Amphion] and train it under identical settings to our training dataset configuration.
...
> <a id="fig:boxplot">![](figs/boxplot_1s.pdf)</a>
...
[^Meng2024Autoregressive]: Autoregressive Speech Synthesis Without Vector Quantization. CoRR 2024.
...
[^Eskimez2024E2]: {E2 TTS}: Embarrassingly Easy Fully Non-Autoregressive Zero-Shot {TTS}. 
...
[^Song2023Consistency]: Consistency Models. Proceedings of the 40th International Conference on Machine Learning 2023.
...
[^Tran2023Sten-Tts]: STEN-TTS: Improving Zero-Shot Cross-Lingual Transfer for Multi-Lingual TTS With Style-Enhanced Normalization Diffusion Framework. Interspeech 2023 2023.
...
[^Ju2024NaturalSpeech]: NaturalSpeech 3: Zero-Shot Speech Synthesis With Factorized Codec and Diffusion Models. Forty-First International Conference on Machine Learning 2024.
...
[^Zeghidour2022SoundStream]: SoundStream: An End-to-End Neural Audio Codec. IEEE/ACM Transactions on Audio, Speech, and Language Processing 2022.
...
[^Saeki2022Utmos]: UTMOS: UTokyo-SaruLab System for VoiceMOS Challenge 2022. 
[^Rix2001Perceptual]: Perceptual Evaluation of Speech Quality (PESQ)-a New Method for Speech Quality Assessment of Telephone Networks and Codecs. 2001 IEEE International Conference on Acoustics, Speech, and Signal Processing. Proceedings (Cat. No.01CH37221) 2001.
...
[^Zhang2024Amphion]: Amphion: An Open-Source Audio, Music and Speech Generation Toolkit. {IEEE} Spoken Language Technology Workshop, {SLT} 2024 2024.
[^He2024Emilia]: Emilia: An Extensive, Multilingual, and Diverse Speech Dataset for Large-Scale Speech Generation. Proc.~of SLT 2024.