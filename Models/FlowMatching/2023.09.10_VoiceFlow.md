...
To only focus on the algorithmic differences, we used the official implementation of GradTTS\footnote{\url{https://github.com/huawei-noah/Speech-Backbones/tree/main/Grad-TTS}} and trained it with the same data configurations.
