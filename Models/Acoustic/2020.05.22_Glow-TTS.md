...
- 链接:
  ...
  - [Publication](https://dl.acm.org/doi/abs/10.5555/3495724.3496400)
  - [Github](https://github.com/jaywalnut310/glow-tts)
  - [Demo](https://jaywalnut310.github.io/glow-tts-demo/index.html)
- 文件:
  - [ArXiv](_PDF/2005.11129v2__Glow-TTS__A_Generative_Flow_for_Text-to-Speech_via_Monotonic_Alignment_Search.pdf)
  - [Publication](_PDF/2005.11129p0__Glow-TTS__NeurIPS2020.pdf)
...
In parallel with our work, [AlignTTS](../TTS2_Acoustic/2020.03.04_AlignTTS.md), [Flowtron](../TTS2_Acoustic/2020.05.12_Flowtron.md), and [Flow-TTS](../TTS2_Acoustic/2020.05.04_Flow-TTS.md) have been proposed.
[AlignTTS](../TTS2_Acoustic/2020.03.04_AlignTTS.md) and [Flow-TTS](../TTS2_Acoustic/2020.05.04_Flow-TTS.md) are parallel TTS models without the need of external aligners, and [Flowtron](../TTS2_Acoustic/2020.05.12_Flowtron.md) is a flow-based model which shows the ability of style transfer and controllability of speech variation.
However, [AlignTTS](../TTS2_Acoustic/2020.03.04_AlignTTS.md) is not a flow-based model but a feed-forward network, and [Flowtron](../TTS2_Acoustic/2020.05.12_Flowtron.md) and Flow TTS use soft attention modules.
...
For any temperature, it shows comparable performance to [Tacotron 2](2017.12.16_Tacotron2.md).
