...
The pursuit of modern text-to-speech (TTS) systems has evolved beyond intelligibility toward the synthesis of genuinely human-like audio, capable of conveying subtle emotions, speaker identity, and contextual nuances [^Shen2017Tacotron2], [^Ping2017Deep], [^Ren2020FastSpeech2], [^Li2019Neural].
...
Autoregressively or Non-autoregressively predicting these tokens from text or phonemes [^Borsos2022AudioLM], [^Kharitonov2023SPEAR-TTS], [^Wang2023VALL-E], [^WangMaskGCT], [^Peng2024VoiceCraft] offers excellent scalability and in-context learning capabilities.
...
Early systems like Tacotron 2 [^Shen2017Tacotron2] and more recent models such as MELLE [^Meng2024MELLE] generate mel-spectrograms autoregressively.
...
**CosyVoice2**[^Du2024CosyVoice2], **CosyVoice3**[^Du2025Cosyvoice] incorporated text-based LLM initialization, streaming synthesis, and large-scale training data for human-parity quality, low latency and in-the-wild scenarios.
...
Higgs Audio v2 [^BosonAI2025Higgs] proposed a unified audio tokenizer captures both semantic and acoustic features, and  pretrained on over 10 million hours of audio data, providing a powerful foundation model.
...
Early systems like Tacotron 2 [^Shen2017Tacotron2] established the encoder-decoder framework for text-to-mel mapping, while FastSpeech [^Ren2020FastSpeech2] introduced explicit duration modeling for alignment stability.
...
[^Ping2017Deep]: Deep Voice 3: Scaling Text-to-Speech With Convolutional Sequence Learning. arXiv:1710.07654.
...
[^Li2019Neural]: Neural Speech Synthesis With Transformer Network. Proceedings of the AAAI Conference on Artificial Intelligence 2019.
...
[^WangMaskGCT]: MaskGCT: Zero-Shot Text-to-Speech With Masked Generative Codec Transformer. The Thirteenth International Conference on Learning Representations .
...
[^Zhou2025IndexTTS2]: IndexTTS2: A Breakthrough in Emotionally Expressive and Duration-Controlled Auto-Regressive Zero-Shot Text-to-Speech. arXiv:2506.21619.
...
[^Li2024Autoregressive]: Autoregressive Image Generation Without Vector Quantization. Advances in Neural Information Processing Systems 2024.
...
[^Pasini2024Continuous]: Continuous Autoregressive Models With Noise Augmentation Avoid Error Accumulation. arXiv:2411.18447.
[^MentzerFinite]: Finite Scalar Quantization: VQ-VAE Made Simple. The Twelfth International Conference on Learning Representations .
...
[^OpenAudio2024OpenAudio]: OpenAudio S1: A Cutting-Edge Text-to-Speech Model That Performs Like Voice Actors. https://openaudio.com/blogs/s1 2024.
[^BosonAI2025Higgs]: Higgs Audio V2: Redefining Expressiveness in Audio Generation. https://github.com/boson-ai/higgs-audio 2025.
[^Wu2025Clear]: CLEAR: Continuous Latent Autoregressive Modeling for High-Quality and Low-Latency Speech Synthesis. arXiv:2508.19098.
[^Wang2025Felle]: FELLE: Autoregressive Speech Synthesis With Token-Wise Coarse-to-Fine Flow Matching. arXiv:2502.11128.
[^An2025Mela-Tts]: MELA-TTS: Joint Transformer-Diffusion Model With Representation Alignment for Speech Synthesis. arXiv:2509.14784.
[^Zhu2024Autoregressive]: Autoregressive Speech Synthesis With Next-Distribution Prediction. arXiv:2412.16846.
[^Lee2025Hierspeech++]: Hierspeech++: Bridging the Gap Between Semantic and Acoustic Representation of Speech by Hierarchical Variational Inference for Zero-Shot Speech Synthesis. IEEE Transactions on Neural Networks and Learning Systems 2025.
[^NishimuraHall-E]: HALL-E: Hierarchical Neural Codec Language Model for Minute-Long Zero-Shot Text-to-Speech Synthesis. The Thirteenth International Conference on Learning Representations .
[^Baas2025Mars6]: MARS6: A Small and Robust Hierarchical-Codec Text-to-Speech Model. ICASSP 2025-2025 IEEE International Conference on Acoustics, Speech and Signal Processing (ICASSP) 2025.
[^Liu2024DiffStyleTTS]: DiffStyleTTS: Diffusion-Based Hierarchical Prosody Modeling for Text-to-Speech With Diverse and Controllable Styles. arXiv:2412.03388.
[^Wang2024Ham-Tts]: Ham-Tts: Hierarchical Acoustic Modeling for Token-Based Zero-Shot Text-to-Speech With Model and Data Scaling. arXiv:2403.05989.
[^Han2025Quantize]: Quantize More, Lose Less: Autoregressive Generation From Residually Quantized Speech Representations. arXiv:2507.12197.
[^Lei2025LeVo]: LeVo: High-Quality Song Generation With Multi-Preference Alignment. arXiv:2506.07520.
[^Team2025Minicpm4]: Minicpm4: Ultra-Efficient LLMS on End Devices. arXiv:2506.07900.
[^He2024Emilia]: Emilia: An Extensive, Multilingual, and Diverse Speech Dataset for Large-Scale Speech Generation. 2024 IEEE Spoken Language Technology Workshop (SLT) 2024.
[^Hu2024Minicpm]: Minicpm: Unveiling the Potential of Small Language Models With Scalable Training Strategies. arXiv:2404.06395.