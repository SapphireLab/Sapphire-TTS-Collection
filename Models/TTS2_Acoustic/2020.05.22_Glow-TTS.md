...
> ***Glow-TTS*** was trained for 240K iterations using the [Adam optimizer](../../Modules/Optim/2014.12.22_Adam.md) with the Noam learning rate schedule ([Transformer](../_Transformer/2017.06.12_Transformer.md)).
