...
> ***Glow-TTS*** was trained for 240K iterations using the [Adam optimizer](../_Basis/2014.12.22_Adam.md) with the Noam learning rate schedule ([Transformer](../../Models/_Basis/2017.06.12_Transformer.md)).
