...
- 对比:
  - [Tacotron2](../../Models/TTS2_Acoustic/2017.12.16_Tacotron2.md) + [Parallel WaveGAN](../../Models/TTS2_Vocoder/2019.08.26_ParallelWaveGAN.md); 
  - [Transformer TTS](../../Models/TTS2_Acoustic/2018.09.19_Transformer_TTS.md) + [Parallel WaveGAN](../../Models/TTS2_Vocoder/2019.08.26_ParallelWaveGAN.md);
  - [FastSpeech](../../Models/TTS2_Acoustic/2019.05.22_FastSpeech.md) + [Parallel WaveGAN](../../Models/TTS2_Vocoder/2019.08.26_ParallelWaveGAN.md);
- 复现:
...
> We use the feed-forward Transformer block, which is a stack of [self-attention](../../Models/_Basis/2017.06.12_Transformer.md) layer and 1D-convolution as in [FastSpeech](../../Models/TTS2_Acoustic/2019.05.22_FastSpeech.md), as the basic structure for the encoder and mel-spectrogram decoder.
...
为了更好地预测音高轮廓的变化, 我们使用连续小波变换嫁给你连续音高序列分解为音高谱图, 并且将音高谱图作为音高预测器的训练目标并采用均方损失训练.
