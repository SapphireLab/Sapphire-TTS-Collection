...
- "A" is SpeechTokenizer~\cite{zhang2023speechtokenizer},
- "B$\sim$" is AcademiCodec~\cite{yang2023hifi},
- "C" is AudioDec~\cite{wu2023audiodec},
- "D" is DAC~\cite{kumar2023high},
- "E$\sim$" is EnCodec~\cite{defossez2023high},
- "F$\sim$" is FunCodec~\cite{du2023funcodec}.

$n_d$ represents the dimension size, SR represents the sample rate.
The contents of this table are partially cited from~\cite{wu2024audiolanguagemodeling}.
</a>
...
For the intelligibility task, we then applied \texttt{whisper-medium}~\cite{radford2022whisper} ASR model, to transcribe the synthetic speech.
