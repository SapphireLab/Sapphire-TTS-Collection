# How Should We Extract Discrete Audio Tokens from Self-Supervised Models? <br我们应该如何从自监督模型中提取离散音频标识符?
...
Over the past few years, continuous representations learned by large self-supervised models such as [Wav2Vec2](../SpeechRepresentation/2020.06.20_Wav2Vec2.0.md), [WavLM](../SpeechRepresentation/2021.10.26_WavLM.md), and [HuBERT](../SpeechRepresentation/2021.06.14_HuBERT.md) have achieved unprecedented performance.
...
Firstly, they facilitate the development of audio language models (LMs) ([AudioLM](../SpeechLM/2022.09.07_AudioLM.md); [AudioPaLM](../SpeechLM/2023.06.22_AudioPaLM.md); [LauraGPT](../SpeechLM/2023.10.07_LauraGPT.md); [VioLA](../SpeechLM/2023.05.25_VioLA.md [VALL-E](../SpeechLM/2023.01.05_VALL-E.md); [SpeechX](../SpeechLM/2023.08.14_SpeechX.md)) and the creation of multi-modal large language models ([Gemini](../TextLM/2023.12.19_Gemini.md)), which can emit audio, text, and visual tokens.
...
Following the terminology from ([AudioLM](../SpeechLM/2022.09.07_AudioLM.md); [SpeechTokenizer](../SpeechCodec/2023.08.31_SpeechTokenizer.md)), audio tokenization techniques can be broadly categorized into Compression-based (codecs) tokens and Semantic tokens.
Compression-based tokens ([SoundStream](../SpeechCodec/2021.07.07_SoundStream.md); defossez2022high, kumar2024high, [HiFi-Codec](../SpeechCodec/2023.05.04_HiFi-Codec.md)) utilize encoder-decoder architectures coupled with [Residual Vector Quantization (RVQ)](../SpeechCodec/2021.07.07_SoundStream.md).
...
Semantic tokens ([Speech Resynthesis](../SpeechCodec/2021.04.01_Speech_Resynthesis_from_Discrete_Disentangled_Self-Supervised_Representations.md); [Phonetic Analysis](Phonetic_Analysis_of_Self-Supervised_Representations_of_English_Speech.md); [W2V-BERT](../SpeechRepresentation/2021.08.07_W2V-BERT.md)), on the other hand, are generated through clustering or quantization of the layers of Self-Supervised Learning (SSL) models ([Wav2Vec2](../SpeechRepresentation/2020.06.20_Wav2Vec2.0.md); [WavLM](../SpeechRepresentation/2021.10.26_WavLM.md); [HuBERT](../SpeechRepresentation/2021.06.14_HuBERT.md)).
...
Recent research, however, has shown that semantic tokens can be effective for generative tasks as well ([SELM](../_tmp/SELM.md); [Towards Universal Speech Discrete Tokens](Towards_Universal_Speech_Discrete_Tokens__A_Case_Study_for_ASR_&_TTS.md)).
Additionally, semantic tokens have been used in a hybrid tokenizer ([SpeechTokenizer](../SpeechCodec/2023.08.31_SpeechTokenizer.md); [FunCodec](../SpeechCodec/2023.09.14_FunCodec.md)).
...
A similar strategy has been widely adopted in audio LLMs ([AudioLM](../SpeechLM/2022.09.07_AudioLM.md); [AudioPaLM](../SpeechLM/2023.06.22_AudioPaLM.md); [LauraGPT](../SpeechLM/2023.10.07_LauraGPT.md)).
Nevertheless, the most effective setting for extracting semantic tokens remains largely unclear.
Recent studies have primarily focused on ASR and Speech Translation ([Chang2023Exploring](2023.09.27_Exploring_Speech_Recognition_Translation_&_Understanding_with_Discrete_Speech_Units__A_Comparative_Study.md); [DUB](../_tmp/DUB.md); [Chang2023Exploration](Exploration_of_Efficient_E2E_ASR_Using_Discretized_Input_from_SSL.md)), without considering a broader range of discriminative and generative tasks.
...
Common strategies include using the middle layer ([SELM](../_tmp/SELM.md); [Speech Resynthesis](../SpeechCodec/2021.04.01_Speech_Resynthesis_from_Discrete_Disentangled_Self-Supervised_Representations.md)) or leveraging the last layer ([Chang2023Exploration](Exploration_of_Efficient_E2E_ASR_Using_Discretized_Input_from_SSL.md)).
...
Since there is no built-in decoder in semantic tokens, a vocoder model for converting the semantic tokens into audio must be trained ([HiFi-GAN](../Vocoder/2020.10.12_HiFi-GAN.md), [WaveGlow](../Vocoder/2018.10.31_WaveGlow.md)).
...
This is achieved through a layer dropout training scheme, inspired by the bitrate scalability mechanism used in [SoundStream](../SpeechCodec/2021.07.07_SoundStream.md).
...
This selection is based on observation from prior research ([WavLM](../SpeechRepresentation/2021.10.26_WavLM.md); [SUPERB](../../Evaluations/2021.05.03_SUPERB.md)) which studied the contribution patterns of different layers across various tasks.
...
As evident from the SSL literature ([Zaiem2023Speech](Speech_Self-Supervised_Representations_Benchmarking__Are_We_Doing_it_Right?.md); [SUPERB](../../Evaluations/2021.05.03_SUPERB.md); [Zaiem2023FineTuning](Fine-Tuning_Strategies_for_Faster_Inference_Using_Speech_Self-Supervised_Models__A_Comparative_Study.md)), the choice of the layer within the SSL model significantly influences the performance of the downstream task of interest.
This decision is equally critical for semantic tokens.
Unlike prior methods that rely on heuristic layer selection ([SELM](../_tmp/SELM.md); [Speech Resynthesis](../SpeechCodec/2021.04.01_Speech_Resynthesis_from_Discrete_Disentangled_Self-Supervised_Representations.md); [Chang2023Exploration](Exploration_of_Efficient_E2E_ASR_Using_Discretized_Input_from_SSL.md)), we integrate the information from our hierarchical multi-layer audio tokens with an attention mechanism.
...
While previous studies ([Chang2023Exploring](2023.09.27_Exploring_Speech_Recognition_Translation_&_Understanding_with_Discrete_Speech_Units__A_Comparative_Study.md), [DUB](../_tmp/DUB.md), [Chang2023Exploration](Exploration_of_Efficient_E2E_ASR_Using_Discretized_Input_from_SSL.md)) have primarily focused on a few discriminative tasks, we aim to provide evidence across a diverse range of speech applications, considering both discriminative and generative tasks.
...
To train such a model, we modify [HiFi-GAN](../SpeechCodec/2023.05.04_HiFi-Codec.md) to accept a variable number of multi-layer discrete tokens as input.
...
For the downstream architecture choices and training procedures, we follow the best-performing approaches for classic continuous self-supervised representations ([Zaiem2023Speech](Speech_Self-Supervised_Representations_Benchmarking__Are_We_Doing_it_Right?.md)).
We employ 1000 centroids across all tasks, except for ASR and emotion recognition, where we adopt 2000 centroids based on insights from prior research on ASR with discrete representations ([Chang2023Exploration](Exploration_of_Efficient_E2E_ASR_Using_Discretized_Input_from_SSL.md)).
...
Therefore, we use the [deep noise suppression mean opinion score (DNSMOS)](../../Evaluations/2020.10.28_DNSMOS.md) for the speech quality metric, following a previous study ([SELM](../_tmp/SELM.md)).
...
Transcriptions are obtained using the small version of [Whisper](../SpeechLM/2022.12.06_Whisper.md).
...
For assessing speech quality, we use [UTMOS](../../Evaluations/2022.04.05_UTMOS.md) to estimate human quality ratings.
To evaluate fidelity to the text, we assess generated samples using the WER computed with the small version of [Whisper](../SpeechLM/2022.12.06_Whisper.md).
...
Our findings align with the observed pattern in continuous representations (["Speech Self-Supervised Representations Benchmarking"](2023.08.28_Speech_Self-Supervised_Representations_Benchmarking__A_Case_for_Larger_Probing_Heads.md)).
