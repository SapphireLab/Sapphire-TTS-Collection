...
> We consider two widely-used models: WavLM-large ([Checkpoints](huggingface.co/microsoft/wavlm-large)) and HuBERT-large ([Checkpoints](huggingface.co/facebook/hubert-large-ll60k)), both having 24 layers.
...
> Noisy samples are generated by mixing clean samples from [LJSpeech](../../Datasets/LJSpeech.md) with noise from [WHAM!](../_tmp/WHAM!.md).
...
> We train all models on the [LJSpeech](../../Datasets/LJSpeech.md) dataset.
