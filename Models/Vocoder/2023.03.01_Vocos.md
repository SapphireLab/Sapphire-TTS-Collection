...
Autoregressive models, like WaveNet, generate audio samples sequentially, conditioning each new sample on all previously generated ones ([SampleRNN](../Vocoder/2016.12.22_SampleRNN.md/../Models/TTS3_Vocoder/2018.02.23_WaveRNN.md); [LPCNet](../Vocoder/2018.10.28_LPCNet.md
On the other hand, non-autoregressive models generate all samples independently, parallelizing the process and making it more computationally efficient ([Parallel WaveNet](../Vocoder/2017.11.28_Parallel_WaveNet.md./../Models/TTS3_Vocoder/2018.10.31_WaveGlow.md); Donahue et al., 2018).
