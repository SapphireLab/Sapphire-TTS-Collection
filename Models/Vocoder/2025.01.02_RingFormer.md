...
- 作者:
  - 01 Seongho Hong (Kwangwoon University)
  - 02 Yong-Hoon Choi (Kwangwoon University)
- 链接:
...
To address these challenges, we propose a novel GAN-based vocoder called ***RingFormer*** that incorporates convolution-augmented Transformers, known as [Conformer [17]](../ASR/2020.05.16_Conformer.md), and an efficient [ring attention [18]](../../Modules/Attention/2023.10.03_RingAttention.md) mechanism introduced in previous research.
...
为了解决这些问题, 我们提出了一种新的基于 GAN 的声码器 ***RingFormer*** 融合了卷积增强的 Transformer ([Conformer [17]](../ASR/2020.05.16_Conformer.md)), 和一种高效的环注意力机制 ([Ring Attention [18]](../../Modules/Attention/2023.10.03_RingAttention.md)).
...
This approach contrasts with the upsampling process in HiFi-GAN, which uses the multi-receptive field fusion (MRF) technique with [×8, ×8, ×2, ×2] transpose convolutions to perform upsampling and reconstruct raw audio.
...
The remaining Conformer blocks, excluding the ring attention, are identical to those in [Ring Attention [18]](../../Modules/Attention/2023.10.03_RingAttention.md).
...
![](Images/2025.01.02_RingFormer_Fig.02.png)
...
剩余的 Conformer 块, 除去环注意力外, 与 [Ring Attention [18]](../../Modules/Attention/2023.10.03_RingAttention.md) 中的相同.
...
[Ring attention [18]](../../Modules/Attention/2023.10.03_RingAttention.md) is a mechanism designed to efficiently process long sequences by leveraging block-wise parallel computation.
...
[环注意力 [18]](../../Modules/Attention/2023.10.03_RingAttention.md) 是一种机制, 旨在有效处理长序列, 通过利用块级并行计算来实现.
在 ***RingFormer*** 中, 环注意力为声码器进行专门处理, 以有效处理长序列的语音信号.

首先, 从 MRF 上采样的梅尔频谱被划分为 $N_d$ 个固定大小的块, 并将每个块分配给单独的设备.
...
![](Images/2025.01.02_RingFormer_Tab.01.png)
...
![](Images/2025.01.02_RingFormer_Tab.03.png)
...
![](Images/2025.01.02_RingFormer_Fig.04.png)

此外图 05 展示了任意查询的注意力得分.

![](Images/2025.01.02_RingFormer_Fig.05.png)
