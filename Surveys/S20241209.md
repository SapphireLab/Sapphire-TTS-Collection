...
Zero-shot controllable TTS ([MaskGCT [78]](../../Models/SpeechLM/ST2S/2024.09.01_MaskGCT.md); [^92]) aims to synthesize speech for unseen speakers with various speech customization such as emotion using minimal reference audio, which can offer flexibility for personalized voice generation.
...
零样本可控 TTS ([MaskGCT [78]](../../Models/SpeechLM/ST2S/2024.09.01_MaskGCT.md); [^92]) 的目标是用最少的参考音频为未见过的说话人合成具有多种语音定制 (如情感) 的语音, 从而为个性化语音生成提供灵活性.
...
Although a few works show great control of emotion, timbres, pitch, gender, and styles, e.g., [VoxInstruct [103]](../../Models/SpeechLM/2024.08.28_VoxInstruct.md) and [CosyVoice [17]](../../Models/SpeechLM/ST2S/2024.07.07_CosyVoice.md), they can frequently synthesize unwanted speech clips.
...
虽然一些工作已经展示出了对情感, 音色, 音高, 性别, 风格等音频属性的精细控制, 如 [VoxInstruct [103]](../../Models/SpeechLM/2024.08.28_VoxInstruct.md) 和 [CosyVoice [17]](../../Models/SpeechLM/ST2S/2024.07.07_CosyVoice.md), 但它们往往会生成不想要的语音片段.
用户需要多次合成才能获得令人满意的语音.
...
Zero-shot TTS emerged in recent years to achieve voice cloning and speech style imitation without fine-tuning, making them more practical in real scenarios ([MaskGCT [78]](../../Models/SpeechLM/ST2S/2024.09.01_MaskGCT.md); [CosyVoice [17]](../../Models/SpeechLM/ST2S/2024.07.07_CosyVoice.md); [F5-TTS [194]](../../Models/Diffusion/2024.10.09_F5-TTS.md)).
...
零样本 TTS 于近年出现以实现声音克隆和语音风格模仿而无需微调, 因此在实际场景中更加实际 ([MaskGCT [78]](../../Models/SpeechLM/ST2S/2024.09.01_MaskGCT.md); [CosyVoice [17]](../../Models/SpeechLM/ST2S/2024.07.07_CosyVoice.md); [F5-TTS [194]](../../Models/Diffusion/2024.10.09_F5-TTS.md)).
...
The inference time is also relatively slow, e.g., existing methods usually take tens of seconds to synthesize a short speech audio clip of less than 10 seconds ([CosyVoice [17]](../../Models/SpeechLM/ST2S/2024.07.07_CosyVoice.md), [Prompttts++ [104]](../../Models/Acoustic/2023.09.15_PromptTTS++.md)).
...
推理时间也相对较慢, 例如, 现有的方法通常需要几十秒才能合成 10 秒以下的短语音音频片段 ([CosyVoice [17]](../../Models/SpeechLM/ST2S/2024.07.07_CosyVoice.md), [Prompttts++ [104]](../../Models/Acoustic/2023.09.15_PromptTTS++.md)).
...
---
<!--
Section 2 - A Overview

```
Linguistic analyzer** aims to extract linguistic features, e.g., phoneme duration and position, syllable stress, and utterance level, from the input text, which is a necessary step in [HHM]-based methods
```
...
B Cnn-based models: ParaNet


sec.06 naturalspeech -> naturalspeech3 -->