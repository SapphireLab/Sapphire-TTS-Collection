...
This type of speech SSL models aims to learn representations by distinguishing a target sample (positives) from distractors (negatives) given an anchor~\cite{mohamed2022self}.
...
As speech lacks a natural boundary of phonetic units~\cite{mohamed2022self}, there are much research efforts to find and locate the underlying acoustic units behind speech utterances in an unsupervised manner~\cite{eloff19_interspeech,dunbar20_interspeech,niekerk20b_interspeech,nguyen2020zero}.
